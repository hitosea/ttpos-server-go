...
return [
    ...
    'params' => [
        ...
        'header' => [
            ...
            ['name' => 'Tid', 'type' => 'string', 'require' => false, 'desc' => '桌台ID(平板专用) - table_id'],
        ],
        // （选配）全局的请求Query
        'query' => [
            // 同上 header
    ...
    'responses' => [
        // 成功响应体
        'success' => [
            ['name' => 'code', 'desc' => '状态码', 'type' => 'int', 'require' => 1, 'default' => 1, 'md' => '/extend/apidocs/HttpStatus.md'],
        ...
        // 异常响应体
        'error' => [
            ['name' => 'code', 'desc' => '状态码', 'type' => 'int', 'require' => 1, 'default' => 0, 'md' => '/extend/apidocs/HttpStatus.md'],
