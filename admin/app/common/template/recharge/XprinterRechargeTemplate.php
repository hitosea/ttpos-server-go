 ...
 * 心烨 充值单模版
 */
class XprinterRechargeTemplate extends BaseTemplate
{
    /**
     * 生成模版
     */
    public function create(UserRechargeOrder $order, $printType)
    {
        ...
        */
        ...
        $printer->setLineSpacing($printType == 'XPRINTER_WIFI' ? 40 : 20);
        $printer->lineFeed(2);
        ...
        $printer->appendText(printText(__("充值后"), '', $this->getPriceAndUnit($balanceLog?->after_money ?: 0), $width));
        // 
