...
namespace app\common\model_old;
...
use app\common\model_old\buffet\BuffetTax;
...
class BaseModelOrder extends BaseModel
{
    ...
    {
        if ($this->parent_id == 0) {
            return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'order_id', 'order_id')->hidden(['content']);
        } else {
            return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'sub_order_id', 'order_id')->hidden(['content']);
        }
    }
    ...
    {
        if ($this->parent_id == 0) {
            return $this->hasMany('app\\common\\model_old\\order\\OrderBuffet', 'order_id', 'order_id');
        } else {
            return $this->hasMany('app\\common\\model_old\\order\\OrderBuffet', 'sub_order_id', 'order_id');
        }
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderBuffetDiscount', 'order_id', 'order_id');
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\Order', 'parent_id', 'order_id');
    }
    ...
    public function buffetCustomerType()
    {
        if ($this->parent_id == 0) {
            ...
            return $this->hasMany('app\\common\\model_old\\order\\OrderBuffetCustomer', 'sub_order_id', 'order_id');
        }
    }
    ...
    {
        if ($this->parent_id == 0) {
            return $this->hasMany('app\\common\\model_old\\order\\OrderDelay', 'order_id', 'order_id');
        } else {
            return $this->hasMany('app\\common\\model_old\\order\\OrderDelay', 'sub_order_id', 'order_id');
        }
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\shop\\User', 'shop_user_id', 'cashier_id')->hidden(['update_time', 'password', 'user_name']);
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\order\\OrderAddress');
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\order\\OrderExtract');
    }
    ...
    {
        return $this->belongsTo('app\\common\\model_old\\user\\User', 'user_id', 'user_id')->field(['user_id', 'mobile', 'nickName', 'real_name']);
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\store\\Table', 'table_id', 'table_id');
    }
    ...
    {
        return $this->belongsTo('app\\common\\model_old\\order\\OrderDeliver', 'order_id', 'order_id')->order('deliver_id desc');
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'order_id', 'order_id')->where('is_send_kitchen', 1)->hidden(['content']);
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'order_id', 'order_id')->where(function ($q) {
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'order_id', 'order_id')->where('is_send_kitchen', 0)->hidden(['content']);
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderProduct', 'order_id', 'order_id')->where('deduct_stock_type', 20)->hidden(['content']);
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\order\\OrderInvoiceInfo', 'order_id', 'order_id')->order('id', 'desc');
    }
    ...
    {
        $prefix = 'jjjfood_';
        return $this->hasMany('app\\common\\model_old\\order\\OrderPayType', 'order_id', 'order_id')
    ...
    {
        $prefix = 'jjjfood_';
        return $this->hasMany('app\\common\\model_old\\order\\OrderRefundDestination', 'order_id', 'order_id')
    ...
    {
        return $this->belongsTo('app\\common\\model_old\\order\\Order', 'parent_id', 'order_id');
    }
    ...
    {
        return $this->belongsTo('app\\common\\model_old\\order\\Order', 'merge_parent_id', 'order_id');
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\OrderRefund', 'order_id', 'order_id')->field(['order_id', 'refund_type', 'refund_money']);
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\order\\Order', 'merge_parent_id', 'order_id');
    }
    ...
    {
        return $this->hasMany('app\\common\\model_old\\erp\\ErpInventoryRecord', 'order_id', 'order_id');
    }
    ...
    {
        return $this->hasOne('app\\common\\model_old\\user\\BalanceLog', 'order_id', 'order_id');
    }
