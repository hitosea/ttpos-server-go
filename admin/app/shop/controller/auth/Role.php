...
class Role extends Controller
{
    ...
    public function editInfo($role_id)
    {
        ...
        $menu = $accessModel->getList($this->store['user']['user_type'], $this->store['supplier']);
        // 获取角色的详细信息
        ...
        // 兼容旧数据 - 指定返回 余额明细 权限ID - 120
        if (in_array(120, $parentIds)) {
            $select_menu = array_merge($select_menu, [120]);
        }
