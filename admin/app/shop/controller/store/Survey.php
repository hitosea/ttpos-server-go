...
class Survey extends Controller
{
     ...
     *    @Apidoc\Param("user_count",type="int",default=0,desc="会员数量"),
     *    @Apidoc\Param("recharge_amount",type="int",default=0,desc="会员充值金额"),
     *    @Apidoc\Param("delivery_order_amount",type="int",default=0,desc="外送订单金额"),
     *    @Apidoc\Param("delivery_order_revenue",type="int",default=0,desc="外送订单营收"),
     *    @Apidoc\Param("delivery_order_refund_amount",type="int",default=0,desc="外送订单退款"),
     *    @Apidoc\Param("delivery_fee",type="int",default=0,desc="外送配送费"),
     *    @Apidoc\Param("delivery_order_num",type="int",default=0,desc="外送订单数"),
     *    @Apidoc\Param("delivery_min_order_price",type="int",default=0,desc="外送最小金额"),
     *    @Apidoc\Param("delivery_max_order_price",type="int",default=0,desc="外送最大金额"),
     *    @Apidoc\Param("delivery_avg_order_price",type="int",default=0,desc="外送平均订单金额"),
