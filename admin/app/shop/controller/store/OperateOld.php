 ...
 * @Apidoc\Sort(4)
 */
class OperateOld extends Controller
{
    /**
     * @Apidoc\Title("订单导出")
     * @Apidoc\Method ("POST")
     * @Apidoc\Url ("/index.php/shop/store.operateOld/export")
     ...
     * @Apidoc\Title("取消订单")
     * @Apidoc\Method ("POST")
     * @Apidoc\Url ("/index.php/shop/store.operateOld/orderCancel")
     ...
     * @Apidoc\Title("删除")
     * @Apidoc\Method ("POST")
     * @Apidoc\Url ("/index.php/shop/store.operateOld/delete")
     * @Apidoc\Param("order_id", type="int", require=true, default="", desc="订单id")
     * @Apidoc\Returned()
     */
    public function delete($sale_bill_uuid)
    {
        $app = AppModel::where('uuid', request()->appId)->find();
        if (!$app->old_company_id) {
            return $this->renderError('未存在迁移库');
        ...
        request()->appId = $app->old_company_id;
        // 
        $model = OrderModel::detail($sale_bill_uuid);
        if (!$model) {
     ...
     * @Apidoc\Url("/index.php/shop/store.operateOld/orderRefund")
     ...
     * })
     */
    public function orderRefund($order_id = 0, $sale_bill_uuid = 0)
    {
        $app = AppModel::where('uuid', request()->appId)->find();
        if (!$app->old_company_id) {
            return $this->renderError('未存在迁移库');
        ...
        $model = OrderModel::detail($sale_bill_uuid ?: $order_id, ['payType', 'refundType', 'mergeList']);
    ...
    //  * @Apidoc\Method ("POST")
    //  * @Apidoc\Url("/index.php/shop/store.operateOld/orderProductList")
    //  * @Apidoc\Param("order_id", type="int",require=true, default=0, desc="订单id")
    //  */
    ...
    //  * @Apidoc\Method ("POST")
    //  * @Apidoc\Url("/index.php/shop/store.operateOld/orderRefundAgain")
