...
class Feed extends Controller
{
     ...
     * @Apidoc\Method ("POST")
     * @Apidoc\Url("/index.php/shop/product.expand.feed/relatedProduct")
     * @Apidoc\Param("feed_id", type="int", require=true, desc="标签id")
    ...
    public function relatedProduct()
    {
        ...
        if ($model->relatedProduct($feed_id, $product_ids)) {
            return $this->renderSuccess('更新成功');
        }
