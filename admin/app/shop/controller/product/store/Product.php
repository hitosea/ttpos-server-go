...
class Product extends Controller
{
     ...
     *   @Apidoc\Param("selling_point_i18n", type="object", require=false, desc="商品卖点多语言"),
     ...
     *      @Apidoc\Param("attribute_min_select", type="int", default=0, require=false, desc="属性最小可选数量（新增）"),
     *      @Apidoc\Param("attribute_max_select", type="int", default=0, require=false, desc="属性最大可选数量，0表示不限制（新增）"),
     *   }),
     ...
     *   }),
     *   @Apidoc\Param("feed_min_select", type="int", default=0, require=false, desc="加料最小可选数量（新增）"),
     *   @Apidoc\Param("feed_max_select", type="int", default=0, require=false, desc="加料最大可选数量，0表示不限制，最多100个（新增）"),
     ...
     *   @Apidoc\Param("package_group", type="array", require=false, desc="套餐分组（最多100个）", children={
     ...
     *      @Apidoc\Param("optional_min_count", type="int", default=1, require=false, desc="套餐分组最小可选数量（新增）"),
     *      @Apidoc\Param("optional_count", type="int", require=true, desc="套餐分组最大可选数量"),
