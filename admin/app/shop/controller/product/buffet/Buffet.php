...
class Buffet extends Controller
{
     ...
     * @Apidoc\Title("顾客类型列表")
     * @Apidoc\Method ("POST")
     * @Apidoc\Url ("/index.php/shop/product.buffet.buffet/customerList")
     * @Apidoc\Param(ref="pageParam")
     * @Apidoc\Returned("list", type="array", ref="app\common\model\buffet\CustomerType\getList")
     */
     ...
     * @Apidoc\Param("is_remain_continue", type="int", require=true, desc="平板是否可继续点餐开关 0-关闭 1-开启")
     * @Apidoc\Param("remain_continue_time", type="int", require=true, desc="剩余xx分不可继续点餐")
     * @Apidoc\Param("remain_continue_notice_time", type="int", require=true, desc="剩余xx分提醒不可继续点餐")
     ...
     * })
     * @Apidoc\Param("product_ids", type="string", require=true, desc="组合产品ids，逗号分隔（v1.0.2弃用）")
     * @Apidoc\Param("products", type="array", require=true, desc="组合产品", children={
     *   @Apidoc\Param("product_id", type="int", require=true, desc="商品id"),
     *   @Apidoc\Param("is_show_cashier", type="int", require=true, desc="是否显示在收银端 1-显示 2-不显示"),
     *   @Apidoc\Param("is_show_tablet", type="int", require=true, desc="是否显示在平板端 1-显示 2-不显示"),
     *   @Apidoc\Param("is_show_kitchen", type="int", require=true, desc="是否显示在厨显端 1-显示 2-不显示"),
     *   @Apidoc\Param("is_show_assistant", type="int", require=true, desc="是否显示在点餐助手 1-显示 2-不显示（v1.0.5）"),
     *   @Apidoc\Param("is_show_h5", type="int", require=true, desc="是否显示在h5 1-显示 2-不显示（v1.0.7）"),
     * })
     ...
     * })
     * @Apidoc\Param("buffetTaxes", type="array", require=true, desc="自助餐关联税类", children={
     *   @Apidoc\Param("buffet_tax_type", type="int", require=true, desc="自助餐关联税类类型，1-堂食税类"),
     ...
     * })
     * @Apidoc\Param("buffetTaxes", type="array", require=true, desc="自助餐关联税类", children={
     *   @Apidoc\Param("buffet_tax_type", type="int", require=true, desc="自自助餐关联税类类型，1-堂食税类"),
     *   @Apidoc\Param("tax_category_id", type="int", require=true, desc="税类id"),
     * })
     * @Apidoc\Returned()
     */
