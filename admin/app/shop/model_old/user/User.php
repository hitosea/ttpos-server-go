...
use app\shop\model_old\user\GradeLog as GradeLogModel;
use app\shop\model_old\user\PointsLog as PointsLogModel;
use app\common\enum\user\pointsLog\PointsLogSceneEnum;
use app\shop\model_old\user\BalanceLog as BalanceLogModel;
