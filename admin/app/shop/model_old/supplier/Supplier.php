...
namespace app\shop\model_old\supplier;

use app\common\model_old\user\User as UserModel;
use app\shop\model_old\auth\User as ShopUserModel;
use app\shop\model_old\product\Product as ProductModel;
use app\shop\model_old\product\Category as CategoryModel;
...
class Supplier extends SupplierModel
{
     ...
     * 获取供应商统计数量
     */
    public function getSupplierData($startDate, $endDate, $type)
    {
        $model = $this;
