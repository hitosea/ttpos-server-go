...
use app\common\model_old\settings\Message as MessageModel;
use app\common\model_old\settings\MessageSettings as MessageSettingsModel;
...
class Message extends MessageModel
{
    ...
    public function getAll($message_to)
    {
        ...
        return $this->withoutGlobalScope()->alias('message')->field([
            'message.*',
            'settings.message_settings_id',
            'settings.sms_status',
            'settings.sms_template',
            'settings.mp_status',
            'settings.mp_template',
            'settings.wx_status',
            'settings.wx_template'
        ])
