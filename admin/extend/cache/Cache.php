...
class Cache extends Manager implements CacheInterface
{
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->clear();
        }
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->set($key, $value, $ttl);
        }
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->delete($key);
        }
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->setMultiple($values, $ttl);
        }
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->deleteMultiple($keys);
        }
    ...
    {
        if ($this->getConfig('default') == 'redis' && $this->getConfig('stores.redis-write')) {
            return $this->store('redis-write')->tag($name);
        }
