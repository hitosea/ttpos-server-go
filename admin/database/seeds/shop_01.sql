...
CREATE TABLE IF NOT EXISTS `ttpos_sale_bill` (
    ...
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售账单ID',
    ...
    consumer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '消费者ID',
    cashier_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '收银员ID',
    buffet_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐订单ID',
    table_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '餐桌ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
    ...
    consumer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '消费者ID',
    cashier_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '收银员ID',
    sale_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售账单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_payment_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '支付订单ID',
    payment_type_name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '支付类型名称',
    payment_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '支付类型ID',
    payment_fee_percent DECIMAL(5, 2) NOT NULL DEFAULT 0 COMMENT '支付手续费百分比',
    sale_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_product` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单商品ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '产品名称',
    flavor_name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '口味名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    ...
    order_product_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '订单产品ID',
    production_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '生产订单ID',
    sign VARCHAR(255) NOT NULL DEFAULT '' COMMENT '商品签名',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    sale_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售账单ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_product_material` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单产品原料ID',
    sale_order_product_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单产品ID',
    bom_uuid INT(11) NOT NULL DEFAULT 0 COMMENT 'BOM ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_product_attribute` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品属性ID',
    sale_order_product_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单产品ID',
    attribute_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品属性ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_discount_strategy` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单优惠策略ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_production_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '生产订单ID',
    table_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '餐桌ID',
    sale_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
    sale_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售账单ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_production_order_product` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '生产订单产品ID',
    ...
    sale_order_product_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单产品ID',
    production_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '生产订单ID',
    first_category_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '一级分类ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_desk_region` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '餐桌区域ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_desk_type` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '餐桌类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_desk` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '桌台ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '桌台名称',
    desk_region_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '桌台区域ID',
    desk_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '桌台类型ID',
    order_by INT(11) NOT NULL DEFAULT 0 COMMENT '排序序号',
...
CREATE TABLE IF NOT EXISTS `ttpos_buffet_customer_type_price` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐顾客类型价格ID',
    buffet_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐套餐ID',
    customer_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '客户类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_buffet_customer_type` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐客户类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_buffet_product` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐产品ID',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_buffet_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐订单ID',
    sale_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售账单ID',
    buffet_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐套餐ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_buffet_customer_type` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单顾客类型ID',
    sale_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
    buffet_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐套餐ID',
    buffet_customer_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '自助餐客户类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_material_attribute` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '原料属性ID',
    material_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '原料ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_material_unit` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '原料单位ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_category` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品类别ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    status TINYINT(1) NOT NULL DEFAULT 0 COMMENT '状态, 0-开启 1-关闭',
    level INT(11) NOT NULL DEFAULT 0 COMMENT '层级',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_unit` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品单位ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '单位名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_special_category` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品特殊类别ID',
    status TINYINT(1) NOT NULL DEFAULT 0 COMMENT '状态, 0-开启 1-关闭',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    order_by INT(11) NOT NULL DEFAULT 0 COMMENT '排序',
...
CREATE TABLE IF NOT EXISTS `ttpos_printer_tag` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机标签ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_flavor` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品规格ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_attribute_group` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品属性组ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_attribute` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品属性ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    attribute_group_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '属性组ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    ...
    unit_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '单位ID',
    dine_tax_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '堂食税ID',
    category_key VARCHAR(255) NOT NULL DEFAULT '' COMMENT '类别关键字',
    category_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '类别ID',
    takeout_tax_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '外卖税ID',
    special_category_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '特殊类别ID',
    printer_tag_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机标签ID',
    status TINYINT(1) NOT NULL DEFAULT 0 COMMENT '状态, 0-上架 1-下架',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package_attribute_group` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包属性组ID',
    is_must TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否必选, 0-否 1-是',
    max_selection INT(11) NOT NULL DEFAULT 0 COMMENT '最大选择数量',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package_attribute` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包属性ID',
    product_package_attribute_group_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包属性组ID',
    attribute_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品属性ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_bom` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品BOM ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    price DECIMAL(12, 2) NOT NULL DEFAULT 0 COMMENT '价格',
    flavor_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '规格ID',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    ref_count INT(11) NOT NULL DEFAULT 0 COMMENT '引用计数',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_bom_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品BOM材料 ID',
    product_bom_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品BOM ID',
    material_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '原料ID',
    num INT(11) NOT NULL DEFAULT 0 COMMENT '数量',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_member` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
    ...
    member_level_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员等级ID',
    member_card_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员卡片ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_member_level` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员等级ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_card_type` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员卡类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_card` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员卡ID',
    card_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员卡类型ID',
    member_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_balance_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '余额变动记录ID',
    member_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_point_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '积分变动记录ID',
    member_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_recharge_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '充值订单ID',
    ...
    member_uuid INT(11) NOT NULL COMMENT '会员ID',
    staff_uuid INT(11) NOT NULL COMMENT '员工ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_member_recharge_order_operation_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '会员充值订单操作日志ID',
    ...
    message VARCHAR(255) NOT NULL DEFAULT '' COMMENT '消息内容',
    recharge_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '充值订单ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_supplier` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '供应商ID',
    ...
    staff_uuid INT(11) NOT NULL COMMENT '员工ID, 采购负责人',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_warehouse_form` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '库存入库单ID',
    ...
    material_uuid INT(11) NOT NULL COMMENT '物料ID',
    purchase_order_uuid INT(11) NOT NULL COMMENT '采购订单ID',
    operator_uuid INT(11) NOT NULL COMMENT '操作员ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_purchase_form` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '采购单ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '采购单名称',
    applicant_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '申请人ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_purchase_form_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '采购单明细ID',
    purchase_form_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '采购单ID',
    material_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '物料ID',
    num INT(11) NOT NULL DEFAULT 0 COMMENT '数量',
...
CREATE TABLE IF NOT EXISTS `ttpos_warehouse_out_form` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '出库单ID',
    ...
    operator_uuid INT(11) NOT NULL COMMENT '操作员ID',
    associated_order_uuid INT(11) NOT NULL COMMENT '关联订单ID',
    revoke_time INT(10) DEFAULT NULL COMMENT '撤销时间（时间戳）',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_warehouse_out_form_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '出库单明细ID',
    warehouse_out_form_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '出库单ID',
    material_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '物料ID',
    num INT(11) NOT NULL DEFAULT 0 COMMENT '数量',
...
CREATE TABLE IF NOT EXISTS `ttpos_loss_report_form` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '报损单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_printer_type` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_printer` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '打印机名称',
    printer_type_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机类型ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
    status TINYINT(1) NOT NULL DEFAULT 0 COMMENT '状态,0-open开启 1-close关闭',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer_region` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机区域ID',
    product_printer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
    region_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '区域ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机明细ID',
    product_printer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
    printer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '打印机ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer_product_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机产品明细ID',
    product_printer_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_sale_inventory` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售库存ID',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    num INT(11) NOT NULL DEFAULT 0 COMMENT '数量',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan_region_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品必选产品计划区域明细ID',
    product_must_product_plan_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
    desk_region_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '桌台区域ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）'
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan_product_item` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品必选产品计划产品明细ID',
    product_must_product_plan_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
    product_package_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '产品包ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_gift_or_free_order_reason` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '赠品或免费订单原因ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_return_food_reason` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退菜原因ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
    multi_language_name_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_multi_language_name` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '多语言名称ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_company_setting` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '集团设置ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_customer_call_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '客户呼叫记录ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_access` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '权限ID',
    ...
    parent_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '父级ID',
    ...
    plus_category_uuid INT(11) DEFAULT 0 COMMENT '插件分类ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_role` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '角色ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_role_access` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '角色权限关系ID',
    role_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '角色ID',
    access_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '权限ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间(时间戳)',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间(时间戳)',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间(时间戳)'
...
CREATE TABLE IF NOT EXISTS `staff_operation_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '操作日志ID',
    staff_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '员工ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_staff_role` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '员工角色关系ID',
    staff_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '超管用户ID',
    role_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '角色ID',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间(时间戳)',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间(时间戳)',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间(时间戳)'
...
CREATE TABLE IF NOT EXISTS `ttpos_bind_record` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '绑定记录ID',
    finally_login_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '最后一个登录id, 退出会清为0',
    ...
    print_port_uuid INT(11) DEFAULT 0 COMMENT '打印档口ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_staff_shift_log` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '交班记录ID',
    staff_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '员工ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_cashier_duty_detail` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '收银交班详情ID',
    staff_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '员工ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_return_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退货单唯一标识符',
    sale_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_return_order_product` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) not null default 0 comment '退货单商品唯一标识符',
    return_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退货单ID',
    ...
    product_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '商品ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_refund_order` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退款单唯一标识符',
    sale_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '销售订单ID',
    sale_order_sn VARCHAR(255) NOT NULL DEFAULT '' COMMENT '销售订单号',
    payment_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '支付单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_cash_box` (
    id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid INT(11) NOT NULL DEFAULT 0 COMMENT '钱箱ID',
    name VARCHAR(255) NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE IF NOT EXISTS `cash_box_log` (
    ...
    remark VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
    payment_bill_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '付款单ID,场景为1时必填',
    return_order_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退货单ID,场景为2时必填',
    refund_order_amount_uuid INT(11) NOT NULL DEFAULT 0 COMMENT '退款单金额ID,场景为3时必填',
    create_time INT(10) NOT NULL DEFAULT 0 COMMENT '创建时间(时间戳)',
    update_time INT(10) NOT NULL DEFAULT 0 COMMENT '更新时间(时间戳)',
    delete_time INT(10) NOT NULL DEFAULT 0 COMMENT '删除时间(时间戳)'
