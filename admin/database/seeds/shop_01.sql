...
CREATE TABLE IF NOT EXISTS `ttpos_payment_method` (
    ...
    `is_show_cashier` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否在收银员界面显示',
    `is_show_assistant` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否在助手界面显示',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_product` (
    ...
    product_package_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包ID',
    sale_bill_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售账单ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_product_material` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售订单产品原料ID',
    sale_order_product_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售订单产品ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_sale_order_product_attribute` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品属性ID',
    sale_order_product_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售订单产品ID',
    ...
    delete_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）',
    UNIQUE KEY `unique_uuid` (`uuid`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '销售订单产品属性记录表';
...
CREATE TABLE IF NOT EXISTS `ttpos_production_order_product` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '生产订单产品ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_buffet_product` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '自助餐产品ID',
    buffet_package_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '自助餐套餐ID',
    product_package_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_material` (
    ...
    num DECIMAL(12, 4) UNSIGNED NOT NULL DEFAULT 0.0000 COMMENT '库存数量',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package_attribute_group` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包属性组ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_package_attribute` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包属性ID',
    product_package_attribute_group_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包属性组ID',
    attribute_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品属性ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_bom` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品BOM ID',
    price DECIMAL(12, 2) NOT NULL DEFAULT 0 COMMENT '价格',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer_region` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品打印机区域ID',
    product_printer_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_printer_product_item` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品打印机产品关联ID',
    product_printer_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品打印机ID',
    product_package_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包ID',
    create_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan` (
    `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    `uuid` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan_region` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品必选产品计划区域明细ID',
    product_must_product_plan_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
    desk_region_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '桌台区域ID',
    create_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
    delete_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_product_must_product_plan_product_item` (
    id INT(11) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '自增ID',
    uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品必选产品计划产品明细ID',
    product_must_product_plan_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品必选产品计划ID',
    product_package_uuid BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '产品包ID',
    create_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间（时间戳）',
    update_time INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间（时间戳）',
...
CREATE TABLE IF NOT EXISTS `ttpos_company_setting` (
    ...
    is_accept_scan_order TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否开启扫码点餐接单 0不开启, 1开启',
