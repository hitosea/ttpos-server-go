...
class UpdateShopAccessAndRoleV220Table extends Migrator
{
    ...
    public function change()
    {
        ...
        $shopAccessData = [
            ...
            ['uuid' => 1731155610, 'name' => '优惠券管理', 'path' => '/marketing/coupon/manage/index', 'api_path' => '', 'parent_uuid' => 1731155609, 'sort' => 2, 'is_route' => 1,  'is_menu' => 1, 'is_show' => 1, 'is_supplier' => 1,  'create_time' => time(), 'update_time' => time()],
            ['uuid' => 1731155611, 'name' => '添加', 'path' => '/marketing/coupon/add', 'api_path' => '', 'parent_uuid' => 1731155610, 'sort' => 2, 'is_route' => 1,  'is_menu' => 1, 'is_show' => 1, 'is_supplier' => 1,  'create_time' => time(), 'update_time' => time()],
            ['uuid' => 1731155612, 'name' => '编辑', 'path' => '/marketing/coupon/edit', 'api_path' => '', 'parent_uuid' => 1731155610, 'sort' => 2, 'is_route' => 1,  'is_menu' => 1, 'is_show' => 1, 'is_supplier' => 1,  'create_time' => time(), 'update_time' => time()],
            ['uuid' => 1731155620, 'name' => '优惠券记录', 'path' => '/marketing/coupon/record/index', 'api_path' => '', 'parent_uuid' => 1731155609, 'sort' => 2, 'is_route' => 1,  'is_menu' => 1, 'is_show' => 1, 'is_supplier' => 1,  'create_time' => time(), 'update_time' => time()],
            // 营销活动
