...
class CreateStatisticsCustomerTypeTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        if (!$this->hasTable('statistics_customer_type')) {
            ...
            $table->addColumn('uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => 'uuid'])
                ...
                ->addColumn('buffet_package_uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => '自助餐套餐ID'])
                ->addColumn('buffet_customer_type_price_uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => '自助餐客户类型价格ID'])
                ->addColumn('product_price', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '销售价,未含税价格（折前）'])
                ->addColumn('product_sale_price', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '原始单价（单人，折前价）。自助餐顾客类型原价,下单后价格不受后台改变'])
