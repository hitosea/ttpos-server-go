...
class CreateStatisticsProductTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        if (!$this->hasTable('statistics_product')) {
            ...
            $table->addColumn('uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => 'uuid'])
                ...
                ->addColumn('product_package_uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => '商品包uuid'])
                ->addColumn('product_bom_uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => '商品清单uuid'])
                ->addColumn('product_price', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '商品单价: 未含税'])
                ->addColumn('product_sale_price', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '商品销售价: 规格+加料'])
                ->addColumn('product_num', 'integer', ['null' => false, 'default' => 0, 'comment' => '商品数量'])
                ->addColumn('tax_rate', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '税率'])
