    ...
    public function change()
    {
        if (!$this->hasTable('member_address')) {
            ...
            $table->addColumn('uuid', 'biginteger', ['default' => 0, 'comment' => '唯一ID'])
                ...
                ->addColumn('phone_prefix', 'string', ['limit' => 10, 'default' => '+66', 'comment' => '手机区号'])
                ...
                ->addColumn('auth_phone', 'string', ['limit' => 20, 'default' => '', 'comment' => '认证手机号'])
                ->addColumn('auth_time', 'integer', ['default' => 0, 'comment' => '认证时间'])
