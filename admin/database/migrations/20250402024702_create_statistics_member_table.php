...
class CreateStatisticsMemberTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        if (!$this->hasTable('statistics_member')) {
            ...
            $table->addColumn('uuid', 'biginteger', ['signed' => false, 'null' => false, 'default' => 0, 'comment' => 'uuid'])
                ...
                ->addColumn('recharge_amount', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '充值金额'])
                ->addColumn('give_amount', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '赠送金额'])
                ->addColumn('give_point', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '赠送积分'])
                ...
                ->addColumn('refund_fee', 'decimal', ['precision' => 14, 'scale' => 2, 'null' => false, 'default' => 0.00, 'comment' => '退款手续费'])
