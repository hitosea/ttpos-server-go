    ...
    public function change()
    {
        ...
        if (!$this->hasTable('warehouse_item')) {
            ...
            $table->addColumn('uuid', 'biginteger', ['default' => 0, 'comment' => 'UUID'])
                  ...
                  ->addColumn('material_uuid', 'biginteger', ['default' => 0, 'comment' => '物品UUID'])
                  ->addColumn('material_code', 'string', ['limit' => 255, 'default' => '', 'comment' => '物品编码'])
                  ->addColumn('stock', 'decimal', ['precision' => 14, 'scale' => 8, 'default' => 0, 'comment' => '库存数量'])
                  ->addColumn('reserved_stock', 'decimal', ['precision' => 14, 'scale' => 8, 'default' => 0, 'comment' => '预留库存数量'])
