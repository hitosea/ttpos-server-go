...
class CreateWarehouseMonthlyFormTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        if (!$this->hasTable('warehouse_monthly_form')) {
            $table = $this->table('warehouse_monthly_form', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_unicode_ci', 'comment' => '月度报表表']);
