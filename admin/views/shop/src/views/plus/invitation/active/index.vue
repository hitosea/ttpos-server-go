<template>
  <div class="user">
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button
            ...
            @click="addClick"
            icon="Plus"
            v-auth="'/plus/invitation/active/add'"
            >添加活动</el-button
          >
        </el-form-item>
      </el-form>
        ...
        <div class="table-wrap">
          ...
          >
            ...
            <el-table-column fixed="right" label="操作" width="200">
              <template #default="scope">
                <el-button
                  v-auth="'/plus/invitation/active/edit'"
                  @click="editClick(scope.row.invitation_gift_id)"
                  type="primary"
                  link
                  size="small"
                  >编辑</el-button
                ...
                <el-button
                  v-else
                  v-auth="'/plus/invitation/active/end'"
                  @click="endClick(scope.row.invitation_gift_id)"
                  type="primary"
                  link
                  size="small"
                  >终止</el-button
                >
                <el-button
                  v-auth="'/plus/invitation/active/partake'"
                  @click="partakeClick(scope.row.invitation_gift_id)"
                  type="primary"
                  link
                  size="small"
                  >参与记录</el-button
                >
                <el-button
                  v-auth="'/plus/invitation/active/receive'"
                  @click="receiveClick(scope.row.invitation_gift_id)"
                  type="primary"
                  link
                  size="small"
                  >礼品记录</el-button
                >
                <el-button
                  v-auth="'/plus/invitation/active/qrcode'"
                ...
                >
                <el-button
                  v-auth="'/plus/invitation/active/delete'"
                  @click="deleteClick(scope.row.invitation_gift_id)"
                  type="primary"
                  link
                  size="small"
                  >删除</el-button
    ...
    <Qrcode
      ...
      :form="currentModel"
      @closeDialog="closeDialogFunc($event, 'qrcode')"
    ></Qrcode>
  </div>
</template>
<script>
