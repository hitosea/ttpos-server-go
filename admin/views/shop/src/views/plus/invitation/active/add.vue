      ...
      <el-form ref="form" :model="form" label-position="top" :rules="formRules" label-width="150px">
        ...
        <div v-for="(item, reward_index) in rewardData" :key="reward_index" class="mt16">
          <div>
            ...
            <el-input type="text" v-model="item.coupon_name" disabled="true" size="" style="width: 200px;"></el-input>
            <el-button type="primary" class="youhui" size="" @click="addCoupon(reward_index)">选择优惠券</el-button>
