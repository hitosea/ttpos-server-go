    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="partake.nickName" label="被邀请人"></el-table-column>
          <el-table-column prop="create_time" label="参加时间"></el-table-column>
        </el-table>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getTableList() {
        ...
        InvitationGiftApi.partakelist(Params, true)
          .then((data) => {
            self.loading = false;
