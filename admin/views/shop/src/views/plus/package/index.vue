          ...
          >
            ...
            <el-table-column fixed="right" width="210" label="操作">
              <template #default="scope">
                <el-button
                  v-auth="'/plus/package/edit'"
                  @click="editClick(scope.row.package_id)"
                  type="primary"
                  link
                  size="small"
                >
                ...
                <el-button
                  ...
                  v-auth="'/plus/package/send'"
                  @click="sendClick(scope.row.package_id)"
                  type="primary"
                  link
                  size="small"
                >
                ...
                <el-button
                  v-else=""
                  v-auth="'/plus/package/send'"
                  @click="endClick(scope.row.package_id)"
                  type="primary"
                  link
                  size="small"
                >
                ...
                <el-button
                  v-auth="'/plus/package/orderlist'"
                  @click="orderClick(scope.row.package_id)"
                  type="primary"
                  link
                  size="small"
                >
                ...
                <el-button
                  v-auth="'/plus/package/delete'"
                  @click="deleteClick(scope.row.package_id)"
                  type="primary"
                  link
                  size="small"
                >
