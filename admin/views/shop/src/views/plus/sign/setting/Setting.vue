<template>
  ...
  <div v-if="!loading">
    <el-form size="small" :model="form" label-position="top" :rules="rules" ref="ruleForm" label-width="100px">
      ...
      <div v-show="form.is_open" class="mt16">
        <!--每日签到固定奖励-->
       ...
       <el-form-item label="额外奖励">
          <div class="reward-list max-w460">
            <div
              ...
              v-for="(item, reward_index) in form.reward_data"
              :key="reward_index"
            >
              <el-button
                class="delete-reward"
              ...
              <el-form-item
                label="连续签到"
                :prop="'reward_data.' + reward_index + '.day'"
                :rules="rules.day"
              >
                <div class="d-s-c">
                  <div class="flex-1">
                ...
                <div class="d-s-c">
                  ...
                  <div v-if="item.is_point">
                    <el-form-item
                      label="送"
                      label-width="40px"
                      :prop="'reward_data.' + reward_index + '.point'"
                      :rules="rules.point"
          ...
          <el-col>
            <el-button size="small" icon="Plus" @click="addReward"
              >添加</el-button
            >
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="规则说明：">
          <div class="edit_container">
            <Uediter :text="ueditor.text" :config="ueditor.config" ref="ue" @contentChange="contentChangeFunc"></Uediter>
          </div>
        </el-form-item>
      </div>
      <!--提交-->
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        SignApi.getData()
          .then(data => {
            ...
            if (val.is_increase == true) {
              self.form.is_increase = true;
            }
            if (val.is_open == true) {
      ...
      onSubmit() {
        ...
        if (params.is_open) {
          params.content = self.ueditor.text;
        }
        self.loading = true;
