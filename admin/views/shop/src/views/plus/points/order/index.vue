      ...
      >
        ...
        <el-form-item>
          <el-button
            ...
            type="primary"
            @click="onExport"
            v-auth="'/plus/points/order/export'"
            >导出</el-button
          >
        </el-form-item>
      </el-form>
          ...
          <el-table-column prop="order_no" label="订单信息" width="330">
            <template #default="scope">
              <div class="product-info">
                <div class="pic">
                  <img v-img-url="scope.row.file_path" alt="" />
                </div>
                <div class="info">
                ...
                <div class="d-c-c d-c">
                  <div class="orange">
                    金额：￥ {{ scope.row.product_price }}
                  </div>
                  <div class="orange">
                    积分： {{ scope.row.product_points }}
                  </div>
          ...
          <el-table-column fixed="right" label="操作" width="150">
            <template #default="scope">
              <el-button
                ...
                link
                size="small"
                v-auth="'/plus/points/order/detail'"
                >订单详情
              </el-button>
              <el-button
                v-if="
  ...
  methods: {
    ...
    verifyClick(row) {
      ...
      ElMessageBox.confirm("确定要核销吗?", "提示", {
        ...
        .then(() => {
          ...
          PointsApi.extract(extract_form, true)
            .then((data) => {
              self.loading = false;
              this.$ElMessage({
                message: $t("操作成功"),
    ...
    onExport: function () {
      ...
      window.location.href =
        baseUrl +
        "/index.php/shop/plus.points.order/export?" +
