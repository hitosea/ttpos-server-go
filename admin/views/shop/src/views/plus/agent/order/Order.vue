      ...
      <div class="table-wrap">
        ...
        >
            ...
            <template #default="scope">
              <div class="order-code d-b-c" v-if="scope.row.is_top_row">
                <div class="d-s-c">
                  ...
                  <span class="pl16"
                    >下单时间：{{ scope.row.create_time }}</span
                  >
                </div>
              </div>
              <template v-else>
                <div
                  class="product-info"
                  v-for="(item, index) in scope.row.order_master.product"
                  :key="index"
                >
                  <div class="pic">
              ...
              <div v-if="!scope.row.is_top_row">
                <div class="d-s-s d-c">
                  <div
                    ...
                    v-if="scope.row.first_user_id > 0"
                  >
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">一级分销商：</span>
                      <span class="blue">{{
                        scope.row.agent_first.nickName
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">用户ID：</span>
                      <span class="gray6">{{
                        scope.row.agent_first.user_id
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                  ...
                  <div
                    class="d-s-c ww100 border-b-d"
                    v-if="scope.row.second_user_id > 0"
                  >
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">二级分销商：</span>
                      <span class="blue">{{
                        scope.row.agent_second.nickName
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">用户ID：</span>
                      <span class="gray6">{{
                        scope.row.agent_second.user_id
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">分销佣金：</span>
                  ...
                  <div
                    class="d-s-c ww100 border-b-d"
                    v-if="scope.row.third_user_id > 0"
                  >
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">三级分销商：</span>
                      <span class="blue">{{
                        scope.row.agent_third.nickName
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">用户ID：</span>
                      <span class="gray6">{{
                        scope.row.agent_third.user_id
                      }}</span>
                    </p>
                    <p class="referee-name text-ellipsis">
                      <span class="gray9">分销佣金：</span>
            ...
            <template #default="scope">
              <div v-if="!scope.row.is_top_row">
                <span class="fb orange">{{
                  scope.row.order_master.pay_price
                }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column
            prop="order_master.user.nickName"
            label="买家"
            width="100"
          ></el-table-column>
          ...
          <el-table-column prop="referee.value" label="佣金结算" width="70">
            <template #default="scope">
              <div v-if="!scope.row.is_top_row">
                <span class="green" v-if="scope.row.is_settled == 1"
                  >已结算</span
                >
