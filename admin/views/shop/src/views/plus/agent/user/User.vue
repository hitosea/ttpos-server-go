    ...
    <div class="product-content">
      <div class="table-wrap">
        ...
        >
          ...
          <el-table-column prop="money" label="累计佣金">
            <template #default="scope">
              <span class="orange">{{ scope.row.money }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="total_money" label="可提现佣金">
            <template #default="scope">
              <span class="orange">{{ scope.row.total_money }}</span>
            </template>
          </el-table-column>
          <el-table-column
            prop="referee.nickName"
            label="推荐人"
          ></el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="210">
            <template #default="scope">
              <div>
                <el-button
                  @click="saleClick(scope.row)"
                  type="primary"
                  link
                  size="small"
                  v-auth="'/plus/agent/order/index'"
                  >订单</el-button
                >
                <el-button
                  @click="detailedClick(scope.row)"
                  type="primary"
                  link
                  size="small"
                  v-auth="'/plus/agent/cash/index'"
                  >提现</el-button
                >
                <el-button
                  @click="openSubUser(scope.row)"
                  type="primary"
                  link
                  size="small"
                  v-auth="'/plus/agent/user/fans'"
                  >下级</el-button
                >
                <el-button
