<template>
  ...
  <div class="pb50" v-loading="loading">
    <div class="product-content">
      ...
      <!--商户信息-->
      <div v-if="detail.supplier">
        <div class="common-form mt16">门店信息</div>
        <div class="table-wrap">
          <el-row>
            <el-col :span="5">
              <div class="pb16">
                <span class="gray9">使用门店名称：</span>
          ...
          <el-row>
            <el-col :span="5">
              <div class="pb16">
                <span class="gray9">门店联系人：</span>
                {{ detail.supplier.link_name }}
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="5">
              <div class="pb16">
                <span class="gray9">门店电话：</span>
                {{ detail.supplier.link_phone }}
              </div>
            </el-col>
          </el-row>
        </div>
      ...
      <!--商户信息-->
      <div v-if="detail.code_no">
        <div class="common-form mt16">券码信息</div>
        <div class="table-wrap">
          <el-row>
            <el-col :span="5">
              <div class="pb16">
                <span class="gray9">核销券码：</span>
                {{ detail.code_no }}
              </div>
            </el-col>
            <el-col :span="5">
              <div class="pb16">
                <span class="gray9">有效期：</span>
                {{ detail.end_time }}
              </div>
            </el-col>
            <el-col :span="5">
