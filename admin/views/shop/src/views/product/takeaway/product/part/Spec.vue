      ...
      <el-input type="number" v-model="form.model.min_buy" class="max-w460"></el-input>
        ...
        <el-form-item label="特色分类：">
            <el-radio-group v-model="form.model.special_id">
                ...
                <el-radio :label="item.category_id" v-for="(item, index) in form.special"
        ...
        <el-form-item label="产品规格：">
            <el-radio-group v-model="form.model.spec_type" @change="changeSpec">
                <el-radio :label="10"
                    v-if="!form.isSpecLocked || (form.isSpecLocked && form.model.spec_type == 10)">单规格</el-radio>
                <el-radio :label="20"
                    v-if="!form.isSpecLocked || (form.isSpecLocked && form.model.spec_type == 20)">多规格</el-radio>
            </el-radio-group>
