<!-- 描述：商品-加料库-添加加料 -->
<template>
  <el-dialog :title="$t('编辑加料')" v-model="dialogVisible" @close="handleClose" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form size="small" :model="form" label-position="top" ref="formRef">
      <UniqueNameForm ref="uniqueNameFormRef" :labelPrefix="$t('加料名称')" apiSource="feed" :apiId="form.feed_id" :overrideLanguages="form.feed_name" />
