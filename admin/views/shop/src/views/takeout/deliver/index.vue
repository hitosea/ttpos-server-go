    ...
    <div class="common-seach-wrap">
      ...
      >
        ...
        <el-form-item label="配送方式">
          <el-select
            size="small"
            v-model="searchForm.deliver_source"
            placeholder="请选择"
          >
            <el-option label="全部" value=""></el-option>
            <el-option
              v-for="(item, index) in deliver_source"
              :key="index"
              :label="item.name"
              :value="item.value"
            >
          ...
          <el-table-column fixed="right" label="操作" width="120">
            <template #default="scope">
              ...
              <el-button
                ...
                v-if="
                  scope.row.deliver_source == 20 ||
                  scope.row.deliver_source == 40 ||
                  (scope.row.deliver_source == 50 && scope.row.status == 10)
                "
                type="primary"
                link
                size="small"
  ...
  methods: {
    ...
    onExport: function () {
      ...
      window.location.href =
        baseUrl +
        "/index.php/shop/takeout.deliver/export?" +
