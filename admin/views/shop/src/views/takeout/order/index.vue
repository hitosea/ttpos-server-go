        ...
        <el-tabs v-model="activeName" @tab-change="handleClick">
          ...
          <el-tab-pane :label="'已完成'" name="complete">
            <template #label>
              <span
                >已完成
                <el-tag size="">{{ order_count.complete }}</el-tag></span
              >
            </template>
          </el-tab-pane>
        </el-tabs>
          ...
          <el-table-column prop="order_no" label="订单信息" width="400">
            <template #default="scope">
              <div class="order-code" v-if="scope.row.is_top_row">
                <span
                  class="state-text"
                  :class="{ 'state-text-red': scope.row.order_source != 10 }"
          ...
          <el-table-column prop="delivery_type.text" label="配送方式">
            <template #default="scope">
              <div v-if="!scope.row.is_top_row">
                ...
                <span v-if="scope.row.delivery_type.value == 30"
            ...
            <template #default="scope">
              <div v-if="!scope.row.is_top_row">
                ...
                <el-button
                  v-if="
                    scope.row.order_status.value == 10 &&
                    scope.row.delivery_status.value == 10 &&
                    scope.row.pay_status.value == 20
                  "
                ...
                <el-button
                  v-if="
                    scope.row.order_status.value == 10 &&
                    scope.row.delivery_type.value == 20 &&
                    scope.row.pay_status.value == 20
                  "
  ...
  methods: {
    ...
    onExport: function () {
      ...
      window.location.href =
        baseUrl +
        "/index.php/shop/takeout.operate/export?" +
