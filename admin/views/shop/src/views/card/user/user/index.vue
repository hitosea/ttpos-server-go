  ...
  <div class="user">
    ...
    <div class="common-seach-wrap flex">
      ...
      <div class="common-level-rail">
        <el-button type="primary" v-auth="'/card/user/user/add'" icon="Plus" @click="addMenber">{{ $t('添加会员') }}</el-button>
      </div>
    </div>
    <!--内容-->
    ...
    <!--扣减-->
    <deduction v-if="open_edit" :open_edit="open_edit" :editData="userModel" @closeDialog="closeDialogFunc($event, 'edit')"></deduction>
