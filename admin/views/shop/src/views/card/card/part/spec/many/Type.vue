    ...
    <div class="spec-wrap">
      <div class="mb16 min-spc" :key="attr.group_name" v-for="(attr, index) in form.model.spec_many.spec_attr">
        <div class="spec-hd">
          ...
          <a href="javascript:void(0);" @click="onDeleteGroup(index)"><i class="Delete"></i></a>
        </div>
        <div class="spec-bd">
      ...
      <div v-if="!form.isSpecLocked">
        <el-button size="small" class="CirclePlus" v-show="showAddGroupBtn" @click="onToggleAddGroupForm">添加规格</el-button>
      </div>
      <!--规格列表-->
