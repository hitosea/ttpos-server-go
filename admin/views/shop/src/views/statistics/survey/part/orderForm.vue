      ...
      <div class="order-box-l">
        ...
        <div class="box-main">
          ...
          <div class="main-body">
            <div class="main-div">
              <h3>{{ $t('订单数') }}</h3>
              <h4>{{ proxy.$formatPrice(detail.scan_order_num || 0) }}</h4>
            </div>

            <div class="main-div">
              <h3>{{ $t('最小/大订单金额') }}</h3>
              <h4>
                {{ proxy.$formatPrice(detail.scan_min_order_price || 0) + '/' + proxy.$formatPrice(detail.scan_max_order_price || 0) }}
              </h4>
            </div>
            <div class="main-div">
              <h3>{{ $t('平均订单金额') }}</h3>
              <h4>
                {{ proxy.$formatPrice(detail.scan_avg_order_price || 0) }}
              </h4>
            </div>
          </div>
        </div>
