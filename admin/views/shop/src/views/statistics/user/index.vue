  ...
  <div class="statistics-member">
      ...
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        <el-form-item :label="$t('收银员')">
          <a-select size="small" v-model:value="searchForm.user_id" :placeholder="$t('请选择')" filterable clearable @change="onSearch">
            ...
            <el-option v-for="(item, index) in exStyle" :key="index" :label="item.real_name" :value="item.shop_user_id"></el-option>
          </a-select>
        </el-form-item>
    ...
    <div class="table-wrap">
      <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
        <el-table-column prop="shift_no" :label="$t('当班编号')" width="180"></el-table-column>
