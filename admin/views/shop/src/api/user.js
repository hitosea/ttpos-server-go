...
let UserApi = {
    /*用户授权*/
    authCode(data, errorback) {
        return request._post('/shop/index/authCode', data, errorback);
    },
    /*用户登录*/
    ...
    //   扣减
    editUserDeduct(data, errorback) {
        return request._post('/shop/user.user/deduct', data, errorback);
    },
    /*充值*/
    ...
    // 客户端KEY
    getPublicKey(data, errorback) {
        return request._post('/shop/passport/getKey', data, errorback);
    },

    // 获取用户信息
    getCardList(data, errorback) {
        return request._post('/shop/card.card/getCardList', data, errorback);
    },
};
