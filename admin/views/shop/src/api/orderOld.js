...
let OrderOldApi = {
    ...
    storeOrderlist(data, errorback) {
        return request._post('/shop/store.orderOld/index', data, errorback);
    },
    /*订单详情*/
    ...
    storeOrderdetail(data, errorback) {
        return request._post('/shop/store.orderOld/detail', data, errorback);
    },
    /*取消*/
    storeConfirm(data, errorback) {
        return request._post('/shop/store.operateOld/orderCancel', data, errorback);
    },
    /*删除*/
    storedelete(data, errorback) {
        return request._post('/shop/store.operateOld/delete', data, errorback);
    },
    ...
    storeRefund(data, errorback) {
        return request._post('/shop/store.operateOld/orderRefund', data, errorback);
    },
    getStoreRefund(data, errorback) {
        return request._get('/shop/store.operateOld/orderRefund', data, errorback);
    },
    ...
    storeExport(data, errorback) {
        return request._get('/shop/store.operateOld/export', data, errorback);
    },
