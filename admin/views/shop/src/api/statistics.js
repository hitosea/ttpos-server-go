...
let StatisticsApi = {
    ...
    /*收银交班*/
    getUserShiftLog(data, errorback) {
        return request._post('/shop/user.UserShiftLog/index', data, errorback);
    },
    getUserShiftLogdDetail(data, errorback) {
        return request._post('/shop/user.UserShiftLog/detail', data, errorback);
    },
    getProductSell(data, errorback) {
        return request._post('/shop/store.product/index', data, errorback);
    },
