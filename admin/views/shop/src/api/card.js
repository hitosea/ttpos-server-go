...
let CardApi = {
  ...
  getSurvey(data, errorback) {
    return request._post('/shop/user.survey/index', data, errorback);
  },
  getRechargeRank(data, errorback) {
    return request._post('/shop/user.survey/rechargeRank', data, errorback);
  },
  getConsumerRank(data, errorback) {
    return request._post('/shop/user.survey/consumerRank', data, errorback);
  },
};
