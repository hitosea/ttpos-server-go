...
let ProductApi = {
  ...
  /*属性组*/
  AttributeGroupList(data, errorback) {
    return request._post('/shop/product.expand.AttrGroup/index', data, errorback);
  },
  addAttributeGroup(data, errorback) {
    return request._post('/shop/product.expand.AttrGroup/add', data, errorback);
  },
  editAttributeGroup(data, errorback) {
    return request._post('/shop/product.expand.AttrGroup/edit', data, errorback);
  },
  deleteAttributeGroup(data, errorback) {
    return request._post('/shop/product.expand.AttrGroup/delete', data, errorback);
  },
  /*加料库*/
  ...
  // 顾客类型列表
  getCustomerList(data, errorback) {
    return request._post('/shop/product.buffet.buffet/customerList', data, errorback);
  },

  // 顾客类型列表
  getTaxList(data, errorback) {
    return request._post('/shop/product.tax.tax/list', data, errorback);
  },

  // 关联商品
  // 打印标签关联商品
  relateByLabel(data, errorback) {
    return request._post('/shop/product.expand.label/relatedProduct', data, errorback);
  },
  // 规格关联商品
  relateBySpec(data, errorback) {
    return request._post('/shop/product.expand.spec/relatedProduct', data, errorback);
  },
  // 加料关联商品
  relateByFeed(data, errorback) {
    return request._post('/shop/product.expand.feed/relatedProduct', data, errorback);
  },
  // 属性关联商品
  relateByAttr(data, errorback) {
    return request._post('/shop/product.expand.attr/relatedProduct', data, errorback);
  },
  // 单位关联商品
  relateByUnit(data, errorback) {
    return request._post('/shop/product.expand.unit/relatedProduct', data, errorback);
  },

  // 批量修改规格价格
  batchProductSpecPrice(data, errorback) {
    return request._post('/shop/product.expand.spec/batchPrice', data, errorback);
  },
  // 批量修改规格价格
  getRelatedProductBySpec(data, errorback) {
    return request._post('/shop/product.expand.spec/skuProduct', data, errorback);
  },

  // 批量上传图片
  batchReplaceProductImage(formData, errorback) {
    return request._upload('/shop/file.Upload/batchReplaceProductImage', formData, errorback);
  },

  // 批量修改分类
  batchUpdateCategory(data, errorback) {
    return request._post('/shop/product.store.product/batchUpdateCategory', data, errorback);
  },

  // 批量修改分类验证
  repeatList(data, errorback) {
    return request._post('/shop/file.Upload/repeatList', data, errorback);
  },
  ...
  // 推荐
  setRecommend(data, errorback) {
    return request._post('/shop/product.store.product/recommend', data, errorback);
  },
};
