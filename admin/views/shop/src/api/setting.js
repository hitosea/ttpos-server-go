...
let SettingApi = {
  ...
  /*货币设置*/
  getCurrencyUnit(data, errorback) {
    return request._get('/shop/setting.Supplier/currencyUnit', data, errorback);
  },
  setCurrencyUnit(data, errorback) {
    return request._post('/shop/setting.Supplier/currencyUnit', data, errorback);
  },

  /*消费税率设置*/
  getTaxRate(data, errorback) {
    return request._get('/shop/setting.Supplier/taxRate', data, errorback);
  },
  setTaxRate(data, errorback) {
    return request._post('/shop/setting.Supplier/taxRate', data, errorback);
  },

  /*服务费设置*/
  getServiceCharge(data, errorback) {
    return request._get('/shop/setting.Supplier/serviceCharge', data, errorback);
  },
  setServiceCharge(data, errorback) {
    return request._post('/shop/setting.Supplier/serviceCharge', data, errorback);
  },

  /*付款方式设置*/
  getPaytype(data, errorback) {
    return request._get('/shop/setting.paytype/index', data, errorback);
  },
  setPaytype(data, errorback) {
    return request._post('/shop/setting.paytype/edit', data, errorback);
  },
  editPayment(data, errorback) {
    return request._post('/shop/setting.paytype/editPayment', data, errorback);
  },
  deletePayment(data, errorback) {
    return request._post('/shop/setting.paytype/delete', data, errorback);
  },
  addPayType(data, errorback) {
    return request._post('/shop/setting.paytype/add', data, errorback);
  },
  defaultPay(data, errorback) {
    return request._post('/shop/setting.paytype/defaultPay', data, errorback);
  },

  /*服务器储存空间*/
  getServerStorage(data, errorback) {
    return request._post('/shop/setting.Store/serverStorage', data, errorback);
  },
  ...
  /*门店业务设置*/
  getBusiness(data, errorback) {
    return request._get('/shop/setting.Business/index', data, errorback);
  },
  setBusiness(data, errorback) {
    return request._post('/shop/setting.Business/index', data, errorback);
  },
  getBusinessQrcode(data, errorback) {
  ...
  setFreeTag(data, errorback) {
    return request._post('/shop/setting.Business/freeTag', data, errorback);
  },

  /*退菜原因*/
  getReturnReason(data, errorback) {
    return request._get('/shop/setting.Business/returnReason', data, errorback);
  },
  setReturnReason(data, errorback) {
    return request._post('/shop/setting.Business/returnReason', data, errorback);
  },

  /*整单备注*/
  getOrderRemark(data, errorback) {
    return request._get('/shop/setting.Business/orderRemark', data, errorback);
  },
  setOrderRemark(data, errorback) {
  ...
  orderSchemeEdit(data, errorback) {
    return request._post('/shop/setting.Business/orderSchemeEdit', data, errorback);
  },
  orderSchemeDel(data, errorback) {
    return request._post('/shop/setting.Business/orderSchemeDel', data, errorback);
  },

  orderSchemeList(data, errorback) {
    return request._post('/shop/setting.Business/orderSchemeList', data, errorback);
  },

  orderSchemeStatus(data, errorback) {
    return request._post('/shop/setting.Business/orderSchemeStatus', data, errorback);
  },

  /*检查是不是新版本*/
  getNewVersion(data, errorback) {
    return request._get('shop/index/getNewVersion', data, errorback);
  },
};
