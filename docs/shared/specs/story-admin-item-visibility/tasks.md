...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/story-admin-item-visibility/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/story-admin-item-visibility/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/story-admin-item-visibility/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/story-admin-item-visibility/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/story-admin-item-visibility/tasks.md)" | bc
```
