...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/active/story-shop-full-reduction-marketing/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/active/story-shop-full-reduction-marketing/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/active/story-shop-full-reduction-marketing/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/active/story-shop-full-reduction-marketing/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/active/story-shop-full-reduction-marketing/tasks.md)" | bc
```
