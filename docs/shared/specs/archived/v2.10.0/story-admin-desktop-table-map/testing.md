...
- **需求文档**: `docs/shared/specs/active/story-admin-desktop-table-map/requirements.md`
- **设计文档**: `docs/shared/specs/active/story-admin-desktop-table-map/design.md`
- **任务清单**: `docs/shared/specs/active/story-admin-desktop-table-map/tasks.md`
