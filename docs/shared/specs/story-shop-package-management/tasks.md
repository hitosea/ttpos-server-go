...
- [x] 4.1 测试指南文档
  ...
  - File: `docs/shared/specs/story-shop-package-management/test-guide.md`
...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/story-shop-package-management/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/story-shop-package-management/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/story-shop-package-management/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/story-shop-package-management/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/story-shop-package-management/tasks.md)" | bc
```
