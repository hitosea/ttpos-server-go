...
- [x] 1.1 确认 Excel 格式规范 ✅
  ...
  - File: `docs/shared/specs/active/story-order-import-data/excel-format.md`
...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/active/story-order-import-data/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/active/story-order-import-data/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/active/story-order-import-data/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/active/story-order-import-data/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/active/story-order-import-data/tasks.md)" | bc
```
