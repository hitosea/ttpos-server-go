...
- [x] 5.1 更新 CHANGELOG
  ...
  - File: `docs/shared/specs/active/task-printer-activity-deduction/CHANGELOG.md`
  - Purpose: 记录本次功能更新
  - Requirements: 文档验收
...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/active/task-printer-activity-deduction/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/active/task-printer-activity-deduction/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/active/task-printer-activity-deduction/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/active/task-printer-activity-deduction/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/active/task-printer-activity-deduction/tasks.md)" | bc
```
