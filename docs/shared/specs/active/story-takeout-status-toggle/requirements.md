...
> 本文档定义 外卖状态切换 的详细需求和验收标准。

## 📋 基本信息

| 项目              | 内容                                                                                                         |
| ----------------- | ------------------------------------------------------------------------------------------------------------ |
| **来源 Proposal** | [docs/team/proposals/2025-12/v2.11.0-takeout-status-toggle.md](../../../../team/proposals/2025-12/v2.11.0-takeout-status-toggle.md) |
| **创建日期**      | 2025-12-13                                                                                                 |
| **负责人**        | weifashi                                                                                                       |
| **目标 Sprint**   | Sprint {N}                                                                                                   |
