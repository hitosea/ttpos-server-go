...
| 项目              | 内容                                                                                                                                        |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **来源 Proposal** | [docs/team/proposals/2025-11/main-nacos-multi-instance-support.md](../../../../team/proposals/2025-11/main-nacos-multi-instance-support.md) |
| **创建日期**      | 2025-11-24                                                                                                                                  |
| **负责人**        | {待分配}                                                                                                                                    |
| **目标 Sprint**   | {待分配}                                                                                                                                    |
...
- **配置解析时间**: < 100ms
- **故障检测响应时间**: < 5 秒（由 Nacos SDK 自动处理）
- **故障切换时间**: < 10 秒（由 Nacos SDK 自动处理）
