...
- [x] 5.2 更新数据库文档
  ...
  - File: `docs/shared/specs/story-pos-full-reduction-marketing/design.md`
  - Purpose: 确保数据库文档完整
  - Requirements: 文档要求
  - Leverage: design.md
  - Success: 数据库文档已更新
...
```bash
# 查看总任务数
grep -c "^- \[" docs/shared/specs/story-pos-full-reduction-marketing/tasks.md

# 查看已完成任务数
grep -c "^- \[x\]" docs/shared/specs/story-pos-full-reduction-marketing/tasks.md

# 查看未完成任务数
grep -c "^- \[ \]" docs/shared/specs/story-pos-full-reduction-marketing/tasks.md

# 计算完成率
echo "scale=2; $(grep -c "^- \[x\]" docs/shared/specs/story-pos-full-reduction-marketing/tasks.md) * 100 / $(grep -c "^- \[" docs/shared/specs/story-pos-full-reduction-marketing/tasks.md)" | bc
```
