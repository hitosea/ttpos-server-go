...
| **关联 Spec** | [task-erp-open-pos-entry-payment-id](../../../shared/specs/archived/v2.12/task-erp-open-pos-entry-payment-id/) |
| **关联任务** | -                                                                 |
...
- `docs/shared/specs/archived/v2.12/task-erp-close-pos-entry-payment-id/` - 关账接口 PaymentID 支持 Spec
...
| **下一步**   | ✅ Spec 已创建：[task-erp-open-pos-entry-payment-id](../../../shared/specs/archived/v2.12/task-erp-open-pos-entry-payment-id/)<br>✅ 技术设计已创建：[design.md](../../../shared/specs/archived/v2.12/task-erp-open-pos-entry-payment-id/design.md)<br>✅ 任务分解已创建：[tasks.md](../../../shared/specs/archived/v2.12/task-erp-open-pos-entry-payment-id/tasks.md)<br>⏳ 等待产品审核 requirements.md |
