...
| **状态**      | 已创建 Spec                                                                                                  |
| **关联任务**  | -                                                                                                            |
| **关联 Spec** | [task-bmp-nacos-multi-instance-support](../../../shared/specs/archived/v2.12/task-bmp-nacos-multi-instance-support/) |
...
> 生产环境部署了 Nacos 集群（3 个节点），但当前代码只能连接其中一个节点。当该节点故障时，所有服务都无法从 Nacos 获取配置和服务发现信息，导致服务不可用。
