...
| **状态**      | 已创建 Spec                                                                                                                                                      |
| **关联任务**  | -                                                                                                                                                                |
| **关联 Spec** | [docs/shared/specs/archived/v2.10.0/task-erp-migrate-command-separation/requirements.md](../../../shared/specs/archived/v2.12/task-erp-migrate-command-separation/requirements.md) |
