...
const file_takeout_proto_rawDesc = "" +
	...
	"\aaddress\x18\x02 \x03(\v2\f.api.AddressR\aaddress\"\x8d\x01\n" +
	"\x14EstimateDistanceResp\x125\n" +
	"\fresponseInfo\x18\x01 \x01(\v2\x11.api.ResponseInfoR\fresponseInfo\x12\x1a\n" +
	"\bdistance\x18\x02 \x01(\x02R\bdistance\x12\"\n" +
	"\ftripDuration\x18\x03 \x01(\x05R\ftripDuration\"\x8f\x02\n" +
	...
	"\fresponseInfo\x18\x01 \x01(\v2\x11.api.ResponseInfoR\fresponseInfo\":\n" +
	"\x10GetDriverInfoReq\x12&\n" +
	"\x0fshop_order_uuid\x18\x01 \x01(\tR\rshopOrderUuid\"\xc8\x01\n" +
	"\x11GetDriverInfoResp\x125\n" +
	"\fresponseInfo\x18\x01 \x01(\v2\x11.api.ResponseInfoR\fresponseInfo\x12\x12\n" +
...
var file_takeout_proto_goTypes = []any{
	...
	(*EstimateDistanceReq)(nil),  // 3: api.EstimateDistanceReq
	(*EstimateDistanceResp)(nil), // 4: api.EstimateDistanceResp
...
var file_takeout_proto_depIdxs = []int32{
	...
	2,  // 1: api.EstimateDistanceResp.responseInfo:type_name -> api.ResponseInfo
