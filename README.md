...
7. 自动验证的错误消息，使用对应结构+Message的map，传递参数，方便国际化，参考收银端登录接口
8. api文档使用https://github.com/swaggo/swag 
9. API接口响应时间要求本地响应200ms以内
10. 服务A依赖服务B，通过传参的形式；服务A不能直接依赖服务B所依赖的repo，方便后期按照服务划分模块
11. 接口声明使用I开头，实现使用Impl结尾；Repository简写成Repo，Service简写成Srv
```code
