            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "订单详情",
                        "schema": {
                            "$ref": "#/definitions/resp.CashierOrderInfoResp"
                        }
                    },
                    "404": {
                        "description": "未找到"
        ...
        "resp.CashierOrderInfo": {
            ...
            "properties": {
                ...
                "products": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resp.CashierOrderProduct"
                    }
                },
                "sale_order_uuid": {
                    "description": "销售订单UUID",
        ...
        "resp.CashierOrderInfoResp": {
            ...
            "properties": {
                "detail": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/resp.CashierOrderInfos"
                        }
                    ]
                },
                "operation_log": {
                    ...
                    "properties": {
                        "list": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/resp.CashierOrderOperationLog"
                            }
                        }
                    }
                }
        ...
        "resp.CashierOrderInfos": {
            ...
            "properties": {
                ...
                "pay_types": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resp.CashierOrderInfoPayTypes"
                    }
                },
                "payment_amount": {
                    "description": "支付金额",
                ...
                "sale_orders": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resp.CashierOrderInfo"
                    }
                },
                "serial_no": {
                    "description": "桌位编号 (点餐流水号)",
