    ...
    "definitions": {
        ...
        "resp.OrderProduct": {
            ...
            "properties": {
                ...
                "price": {
                    "description": "最终单价(单商品，会员、会员卡和优惠折扣后，折后价)。销售价*折扣率'",
                    "type": "number"
                },
                "refund_amount": {
                    "description": "退款金额",
                ...
                "sale_price": {
                    "description": "销售价（单商品，折前价）,当自定义价格时，销售价=自定义价格,否则销售价=原始单价",
                    "type": "number"
                },
                "status": {
                ...
                "tax_rate": {
                    "description": "税率,单位%.下单时单税率,结账时再重新核算",
                    "type": "number"
                },
                "total_price": {
                    "description": "应收金额(单商品)=最终单价+服务费+总税费",
                    "type": "number"
                },
                "total_sale_price": {
                    "description": "销售价（单商品，折前价）,当自定义价格时，销售价=自定义价格,否则销售价=原始单价'",
