...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/h5/index.php/scan/order.Order/buffetList": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/h5/index.php/scan/order.Order/setTable": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
                ...
                "parameters": [
                    {
                        "description": "创建扫码桌台订单参数",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/req.OpenDeskRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/h5/index.php/scan/product.category/index": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/resp.H5CategoryList"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "req.BuffetCustomerType": {
            "type": "object",
            "properties": {
                "customer_type_id": {
                    "description": "自助餐顾客类型ID",
                    "type": "integer"
                },
                "name_text": {
                    "description": "自助餐顾客类型名称",
                    "type": "string"
                },
                "num": {
                    "description": "顾客数量",
        ...
        "req.OpenDeskRequest": {
            ...
            "properties": {
                "buffet_customer_type": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/req.BuffetCustomerType"
                    }
                },
                "buffet_ids": {
                    "description": "自助餐ID",
        ...
        "resp.H5Buffet": {
            ...
            "properties": {
                ...
                "buffetCustomerType": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resp.H5BuffetCustomerType"
                    }
                },
                "buffetTaxes": {
                    "type": "array",
        ...
        "resp.H5CategoryList": {
            ...
            "properties": {
                "list": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resp.H5Category"
                    }
                }
            }
        },
