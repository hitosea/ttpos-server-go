...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/req.CreateRechargeOrderReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/cashier/member/in_progress_recharge_order": {
            "get": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/index.php/scan/base.base/getInfo": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/index.php/scan/order.Order/buffetList": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/index.php/scan/order.Order/remark": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/index.php/scan/order.Order/setTable": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
        ...
        "/index.php/scan/product.category/index": {
            "post": {
                "security": [
                    {
                        "JwtToken": []
    ...
    "definitions": {
        ...
        "resp.PaymentOrder": {
            ...
            "properties": {
                "amount": {
                    "description": "支付订单金额 = payment_amount + payment_commission_fee",
                    "type": "number"
                },
                "payment_method_uuid": {
                    "description": "支付方式Uuid",
