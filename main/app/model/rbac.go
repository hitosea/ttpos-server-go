...
type Access struct {
	...
	ParentUuid       int64  `gorm:"column:parent_uuid;type:bigint(20);default:0;comment:父级ID;NOT NULL" json:"parent_uuid"`
	...
	PlusCategoryUuid int64  `gorm:"column:plus_category_uuid;type:bigint(20);default:0;comment:插件分类ID" json:"plus_category_uuid"`
