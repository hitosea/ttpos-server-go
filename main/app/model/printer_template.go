...
type PrinterTemplate struct {
	...
	TmpUuid    uint64 `gorm:"column:tmp_uuid;type:bigint;not null;default:0" json:"tmp_uuid" form:"tmp_uuid"`           // 临时模板UUID
	TmpData    string `gorm:"column:tmp_data;type:text" json:"tmp_data" form:"tmp_data"`                                // 临时模板数据
