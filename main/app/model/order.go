...
type SaleBill struct {
	...
	UUID            uint    `gorm:"column:uuid;type:bigint(20);default:0;comment:销售账单ID" json:"uuid"`
	...
	ConsumerUUID    uint    `gorm:"column:consumer_uuid;type:bigint(20);default:0;comment:消费者ID" json:"consumer_uuid"`
	CashierUUID     uint    `gorm:"column:cashier_uuid;type:bigint(20);default:0;comment:收银员ID" json:"cashier_uuid"`
	BuffetOrderUUID uint    `gorm:"column:buffet_order_uuid;type:bigint(20);default:0;comment:自助餐订单ID" json:"buffet_order_uuid"`
	TableUUID       uint    `gorm:"column:table_uuid;type:bigint(20);default:0;comment:餐桌ID" json:"table_uuid"`
...
type SaleOrder struct {
	ID                    uint    `gorm:"column:id;type:int(10);primary_key;AUTO_INCREMENT;comment:主键id" json:"id"`
	UUID                  uint    `gorm:"column:uuid;type:bigint(20);default:0;comment:销售订单ID" json:"uuid"`
	...
	ConsumerUUID          uint    `gorm:"column:consumer_uuid;type:bigint(20);default:0;comment:消费者ID" json:"consumer_uuid"`
	CashierUUID           uint    `gorm:"column:cashier_uuid;type:bigint(20);default:0;comment:收银员ID" json:"cashier_uuid"`
	SaleBillUUID          uint    `gorm:"column:sale_bill_uuid;type:bigint(20);default:0;comment:销售账单ID" json:"sale_bill_uuid"`
