...
type StockReconciliation struct {
	...
	CreatorStaffUuid   uint64 `gorm:"column:creator_staff_uuid;not null;default:0;comment:发起人员工UUID" json:"creator_staff_uuid"`
	SubmitterStaffUuid uint64 `gorm:"column:submitter_staff_uuid;not null;default:0;comment:提交人员工UUID" json:"submitter_staff_uuid"`
