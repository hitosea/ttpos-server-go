...
type PurchaseLimitScheme struct {
	...
	Status          int8   `gorm:"column:status;type:tinyint(1);not null;default:0;comment:'状态：0=关闭，1=开启';index:idx_status" json:"status"`
	ApplyToAllShops int8   `gorm:"column:apply_to_all_shops;type:tinyint(1);not null;default:0;comment:'是否适用所有门店：0=否，1=是'" json:"apply_to_all_shops"`
