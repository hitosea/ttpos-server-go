...
type MemberLevel struct {
	...
	OpenPoint    int    `gorm:"column:open_point;type:tinyint(3);default:0;comment:是否开放累计积分升级，0-否 1-是"`
	UpgradePoint int    `gorm:"column:upgrade_point;type:int(11);default:0;comment:升级条件，累计积分"`
...
type MemberCardType struct {
	...
	Expire       int     `gorm:"column:expire;type:int(11);default:0;comment:有效期限,单位:月, 0为永久有效;"`
	...
	OpenPoint    int     `gorm:"column:open_point;type:tinyint(1);default:0;comment:开卡赠送积分,0-否 1-是;"`
	OpenPointNum float64 `gorm:"column:open_point_num;type:decimal(12,2);default:0.00;comment:开卡赠送积分数;"`
	OpenMoney    int     `gorm:"column:open_money;type:tinyint(1);default:0;comment:开卡赠送余额,0-否 1-是;"`
	OpenMoneyNum float64 `gorm:"column:open_money_num;type:decimal(12,2);default:0.00;comment:开卡赠送余额数;"`
	Describe     string  `gorm:"column:describe;type:varchar(255);comment:使用须知;"`
}
...
type MemberCardLog struct {
	...
	Expire             int     `gorm:"column:expire;type:int(11);default:0;comment:有效期限,单位:月, 0为永久有效,不随后台改变,记录领取时的有效期限"`
...
type MemberBalanceLog struct {
	...
	Describe   string  `gorm:"column:describe;type:varchar(255);default:'';comment:变动描述"`
}
