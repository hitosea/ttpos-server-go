...
type Member struct {
	...
	Uuid               uint64  `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:'会员ID';" json:"uuid"`
...
type MemberLevel struct {
	ID            uint   `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID""`
	Uuid          uint64 `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:会员等级ID;""`
...
type MemberCard struct {
	...
	Uuid         uint64 `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:会员卡ID;" json:"uuid"`
	...
	CreateTime   int64  `gorm:"autoCreateTime;column:create_time;type:int(10);comment:创建时间(时间戳);" json:"create_time"`
	UpdateTime   int64  `gorm:"autoUpdateTime;column:update_time;type:int(10);comment:更新时间(时间戳);" json:"update_time"`
...
type MemberCardType struct {
	ID              uint    `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID" `
	Uuid            uint64  `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:会员卡类型ID;"`
...
type MemberCardLog struct {
	ID                 uint    `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID"`
	Uuid               uint64  `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:会员卡领取记录ID"`
...
type MemberBalanceLog struct {
	ID          uint    `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID"`
	Uuid        uint64  `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:余额变动记录ID"`
	MemberUuid  uint64  `gorm:"column:member_uuid;type:bigint(20) unsigned;default:0;comment:会员ID"`
...
type MemberPointLog struct {
	ID          uint   `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID"`
	Uuid        uint64 `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:积分变动记录ID"`
	MemberUuid  uint64 `gorm:"column:member_uuid;type:bigint(20) unsigned;default:0;comment:会员ID"`
...
type MemberRechargeOrder struct {
	ID             uint    `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID"`
	Uuid           uint64  `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:充值订单ID"`
...
type MemberRechargeOrderOperationLog struct {
	ID                uint   `gorm:"column:id;type:int(11) unsigned;primary_key;AUTO_INCREMENT;comment:自增ID"`
	Uuid              uint64 `gorm:"column:uuid;type:bigint(20) unsigned;default:0;comment:会员充值订单操作日志ID"`
