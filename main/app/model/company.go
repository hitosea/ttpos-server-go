...
type CompanySetting struct {
	...
	IsOpenAdvancedTicketPrint int    `gorm:"column:is_open_advanced_ticket_print;type:int(11);default:0;comment:是否开启高级票据打印模板: 0不开启, 1开启;NOT NULL" json:"is_open_advanced_ticket_print"`
	...
	ErpnextHeadquarterAbbr    string `gorm:"column:erpnext_headquarter_abbr;type:varchar(255);default:'';comment:ERPNext总部简称;NOT NULL" json:"erpnext_headquarter_abbr"`
