...
type MarketingActivity struct {
	...
	RewardLimit           int     `gorm:"column:reward_limit;type:int;default:0;comment:奖励次数限制" json:"reward_limit"`
...
type MarketingActivityRecord struct {
	...
	LastRewardTime int    `gorm:"column:last_reward_time;type:int;default:0;comment:最后一次获得奖励时间" json:"last_reward_time"`
}
