	...
	testData := map[string]interface{}{
		...
		"order": map[string]interface{}{
			...
			"buffets": []map[string]interface{}{
				{"name": "我是自助餐1", "price_num": "2124*121", "subtotal": "1112312.00", "info": "大人"},
				{"name": "我是自助餐2", "price_num": "24*12", "subtotal": 88.00, "info": "小孩"},
			},
			"delays": []map[string]interface{}{
				{"name": "我是加钟1", "price_num": "24*12", "subtotal": 138.00},
			},
			"products": []map[string]interface{}{
				{"name": "北京烤鸭", "price_num": "24*12", "subtotal": 138.00, "info": "份"},
				{"name": "清蒸鲈鱼", "price_num": "24*12", "subtotal": 88.00, "info": "个"},
				{
					"name":           "麻婆豆腐",
					"price_num":      "24*12",
					"price":          24,
