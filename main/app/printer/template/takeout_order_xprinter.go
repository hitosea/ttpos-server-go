...
// takeoutOrderXprinterTemplate XPrinter订单打印模板
type takeoutOrderXprinterTemplate struct {
	base *printerTemplate
}

// NewTakeoutOrderXprinterTemplate 创建新的XPrinter订单打印模板
func NewTakeoutOrderXprinterTemplate(
	base *printerTemplate,
) *takeoutOrderXprinterTemplate {
	return &takeoutOrderXprinterTemplate{
		base: base,
	}
}

// GetPrintnrContent 获取打印内容
func (t *takeoutOrderXprinterTemplate) GetPrintContent(
	printerType string,
	temp int,
