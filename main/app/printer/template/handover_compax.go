...
func (t *handoverCompaxTemplate) GetPrintContent(
	...
	if temp == 2 || temp == 3 {
		...
		printer.LineFeed(1)
		printer.SetAlignment(pkg.AlignLeft)
		printer.AppendText(t.base.PrintText(t.base.Translate("最小/大订单金额"), "", fmt.Sprintf("%s/%s", t.base.GetPriceAndUnit(businessData.CashierMinOrderPrice), t.base.GetPriceAndUnit(businessData.CashierMaxOrderPrice)), width-differenceWidth*2))
		printer.LineFeed(1)
		printer.SetAlignment(pkg.AlignLeft)
		printer.AppendText(t.base.PrintText(t.base.Translate("平均订单金额"), "", t.base.GetPriceAndUnit(businessData.CashierAvgOrderPrice), width-differenceWidth))
		printer.LineFeed(1)
		// 支付方式
		printer.AppendText("------------------------------------------------")
		printer.SetPrintModes(true, false, false)
