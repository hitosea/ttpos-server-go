...
// CustomerCallRepoInterface 客户呼叫记录
...
// NewCustomerCallRepoImpl 创建新的客户呼叫记录仓库实现
...
// GetCustomerCallList 获取客户呼叫记录列表，排除逻辑删除的客户呼叫记录
