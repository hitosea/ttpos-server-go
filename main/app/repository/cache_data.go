...
// 缓存键常量，避免重复的字符串格式化
const (
	CACHE_KEY_DESK                        = "{TTPOS_GORM_CACHE_DATA}:%v:DESK:%v"
	CACHE_KEY_BUFFET_CUSTOMER_TYPE_PRICES = "{TTPOS_GORM_CACHE_DATA}:%v:BUFFET_CUSTOMER_TYPE_PRICES:%v"
	CACHE_KEY_BUFFET_PACKAGE              = "{TTPOS_GORM_CACHE_DATA}:%v:BUFFET_PACKAGE:%v"
	CACHE_KEY_BUFFET_PRODUCTS             = "{TTPOS_GORM_CACHE_DATA}:%v:BUFFET_PRODUCTS:%v"
	CACHE_KEY_PRODUCT_PACKAGE             = "{TTPOS_GORM_CACHE_DATA}:%v:PRODUCT_PACKAGE_UUID:%v"
	CACHE_KEY_PRODUCT_BOM                 = "{TTPOS_GORM_CACHE_DATA}:%v:PRODUCT_BOM_UUID:%v"
	CACHE_KEY_PRODUCT_ATTRIBUTE           = "{TTPOS_GORM_CACHE_DATA}:%v:PRODUCT_ATTRIBUTE_UUID:%v"
)
