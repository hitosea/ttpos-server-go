...
var once_hide_sale_bill_event_handler sync.Once

// hideSaleBillEventHandler "挂单"事件处理器
func HideSaleBillEventHandler() {
	once_hide_sale_bill_event_handler.Do(func() {
