...
var once_checkout_zero_cancel_sale_order_event_handler sync.Once

// init 自动注册事件处理器
func init() {
	// 只初始化一次
	checkoutZeroCancelSaleOrderEventHandler()
}

// checkoutZeroCancelSaleOrderEventHandler "结账撤销抹零"事件处理器
func checkoutZeroCancelSaleOrderEventHandler() {
	once_checkout_zero_cancel_sale_order_event_handler.Do(func() {
