...
func (h *DeskHandler) CreateDeskOrder(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "create_desk_order").
		WithBill(0, 0).
...
func (h *DeskHandler) SetOrderSource(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "set_order_source").
...
func (h *DeskHandler) SetNationality(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "set_nationality").
		WithBill(payload.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) CloseDesk(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "close_desk").
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) CompleteDesk(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "complete_desk").
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) ChangeDesk(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "change_desk").
...
func (h *DeskHandler) CancelDeskOrder(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cancel_desk_order").
...
func (h *DeskHandler) OrderProductDelete(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_product_delete").
...
func (h *DeskHandler) OrderProductChangePrice(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_product_change_price").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderDiscountCancel(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_discount_cancel").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderChangePopulation(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_change_population").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderChangeBuffet(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_change_buffet").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderChangeBuffetClock(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_change_buffet_clock").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderProductRemark(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_product_remark").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderRemark(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_remark").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
	//
...
func (h *DeskHandler) OrderCartProductAdd(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_add").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 添加商品。 若没有点餐账单则新建一个
...
func (h *DeskHandler) OrderCartProductPackageAdd(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_package_add").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 向购物车添加套餐
...
func (h *DeskHandler) OrderCartProductFlavorAndAttributeChange(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_flavor_change").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 修改购物车商品"规格/属性"
...
func (h *DeskHandler) OrderCartProductNum(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_num").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderCartProductCooking(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_cooking").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderCartProductReturning(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_returning").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 退菜购物车商品
...
func (h *DeskHandler) OrderCartProductCancelReturning(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_cancel_returning").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 退菜购物车商品
...
func (h *DeskHandler) OrderCartProductChangeDesk(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_change_desk").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 转菜购物车商品
...
func (h *DeskHandler) OrderCartProductWrap(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_wrap").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 打包单商品
...
func (h *DeskHandler) OrderCartProductUnwrap(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_unwrap").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 取消打包单商品
...
func (h *DeskHandler) OrderCartProductGiving(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_giving").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 赠菜购物车商品
...
func (h *DeskHandler) OrderCartProductCancelGiving(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_cancel_giving").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
	// 取消赠菜购物车商品
...
func (h *DeskHandler) OrderMustPlanConfirm(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "must_plan_confirm").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderCheck(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_check").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderPaymentCreate(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "payment_create").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderPaymentCancel(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "payment_cancel").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderFree(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_free").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderPaymentZeroRule(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "payment_zero_rule").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderSaleOrderCreate(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "sale_order_create").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderSaleOrderMoveProduct(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "sale_order_move_product").
...
func (h *DeskHandler) OrderSaleOrderDelete(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "sale_order_delete").
		WithBill(params.SaleBillUuid, params.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderSaleOrderDeleteAll(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "sale_order_delete_all").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderUseMember(c *gin.Context) {
	...
	ctx := helper.GetContext(c)
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_use_member").
...
func (h *DeskHandler) OrderMemberCancel(c *gin.Context) {
	...
	ctx := helper.GetContext(c)
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_member_cancel").
		WithBill(passwordReq.SaleBillUuid, passwordReq.SaleOrderUuid).
		WithPath(c.Request.URL.Path)
...
func (h *DeskHandler) OrderPrint(c *gin.Context) {
	...
	ctx := helper.GetContext(c)
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_print").
...
func (h *DeskHandler) OrderPrintInvoice(c *gin.Context) {
	...
	ctx := helper.GetContext(c)
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_print_invoice").
...
func (h *DeskHandler) OrderUnlock(c *gin.Context) {
	...
	ctx := helper.GetContext(c)
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "order_unlock").
...
func (h *DeskHandler) OrderCartProductBatchCooking(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "cart_product_batch_cooking").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
	// 分批送厨弹框的销售订单商品列表
...
func (h *DeskHandler) ChangeBatchTag(c *gin.Context) {
	...
	// 开始耗时跟踪
	tracker := helper.StartTrack(ctx, "change_batch_tag").
		WithBill(params.SaleBillUuid, 0).
		WithPath(c.Request.URL.Path)
	// 更换分批类型
