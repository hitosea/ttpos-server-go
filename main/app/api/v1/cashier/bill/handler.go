...
// @Router /cashier/bill/cancel/{id} [delete]
func (h *Handler) DeleteCashierBillCancel(c *gin.Context) {
}
...
// @Success 204 {object} nil "无内容"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/discount/{id} [delete]
func (h *Handler) DeleteCashierBillDiscount(c *gin.Context) {
	// 处理删除收银账单折扣的逻辑
}
...
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/discount [post]
func (h *Handler) PostCashierBillDiscount(c *gin.Context) {
	// 处理发布收银账单折扣的逻辑
}
...
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/discount/change_price/{id} [post]
func (h *Handler) PostCashierBillDiscountChangePrice(c *gin.Context) {
	// 处理更改收银账单折扣价格的逻辑
}
...
// @Success 201 {object} nil "已创建"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/discount/gift [post]
func (h *Handler) PostCashierBillDiscountGift(c *gin.Context) {
	// 处理发布收银账单折扣礼物的逻辑
}
...
// @Success 201 {object} nil "已创建"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/discount/small_change [post]
func (h *Handler) PostCashierBillDiscountSmallChange(c *gin.Context) {
	// 处理发布收银账单小额变更的逻辑
}
...
// @Router /cashier/bill/order/check/{orderId} [get]
func (h *Handler) GetCashierBillOrderCheck(c *gin.Context) {
	// 处理检查收银账单订单的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/finish_payment/{orderId} [post]
func (h *Handler) PostCashierBillOrderFinishPayment(c *gin.Context) {
	// 处理完成收银账单订单支付的逻辑
}
...
// @Success 204 {object} nil "无内容"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/member/{memberId} [delete]
func (h *Handler) DeleteCashierBillOrderMember(c *gin.Context) {
	// 处理删除收银账单订单中的成员的逻辑
}
...
// @Success 201 {object} nil "已创建"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/member [post]
func (h *Handler) PostCashierBillOrderMember(c *gin.Context) {
	// 处理添加成员到收银账单订单的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/pay/{orderId} [post]
func (h *Handler) PostCashierBillOrderPay(c *gin.Context) {
	// 处理收银账单订单支付的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/payment_small_change_strategy [post]
func (h *Handler) PostCashierBillOrderPaymentSmallChangeStrategy(c *gin.Context) {
	// 处理收银账单订单的小额支付策略的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/printer/invoice/{orderId} [post]
func (h *Handler) PostCashierBillOrderPrinterInvoice(c *gin.Context) {
	// 处理打印收银账单订单发票的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/printer/payment_bill/{orderId} [post]
func (h *Handler) PostCashierBillOrderPrinterPaymentBill(c *gin.Context) {
	// 处理打印收银账单订单支付账单的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/printer/pre_payment_bill/{orderId} [post]
func (h *Handler) PostCashierBillOrderPrinterPrePaymentBill(c *gin.Context) {
	// 处理打印收银账单订单预付款账单的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/production/cancel_return/{orderId} [post]
func (h *Handler) PostCashierBillOrderProductionCancelReturn(c *gin.Context) {
	// 处理取消收银账单订单的退货的逻辑
}
...
// @Failure 404 {object} nil "未找到"
// @Router /cashier/bill/order/production_order/finished_product/status/{orderId} [get]
func (h *Handler) GetCashierBillOrderProductionOrderFinishedProductStatus(c *gin.Context) {
	// 处理获取收银账单订单的成品状态的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/order/revoke_pay/{orderId} [post]
func (h *Handler) PostCashierBillOrderRevokePay(c *gin.Context) {
	// 处理撤销收银账单订单支付的逻辑
}
...
// @Success 204 {object} nil "无内容"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/sub_bill/{subBillId} [delete]
func (h *Handler) DeleteCashierBillSubBill(c *gin.Context) {
	// 处理删除收银账单的子账单的逻辑
}
...
// @Success 201 {object} nil "已创建"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/sub_bill [post]
func (h *Handler) PostCashierBillSubBill(c *gin.Context) {
	// 处理发布收银账单的子账单的逻辑
}
...
// @Success 200 {object} nil "成功"
// @Failure 400 {object} nil "错误请求"
// @Router /cashier/bill/sub_bill/product/move [post]
func (h *Handler) PostCashierBillSubBillProductMove(c *gin.Context) {
	// 处理在子账单中移动产品的逻辑
}
