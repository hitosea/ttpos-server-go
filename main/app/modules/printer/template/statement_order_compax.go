...
// statementOrderCompaxTemplate Compax订单打印模板
type statementOrderCompaxTemplate struct {
	base *printerTemplate
}

// NewStatementOrderCompaxTemplate 创建新的Compax订单打印模板
func NewStatementOrderCompaxTemplate(
	base *printerTemplate,
) *statementOrderCompaxTemplate {
	return &statementOrderCompaxTemplate{
		base: base,
	}
}
