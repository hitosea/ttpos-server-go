...
type businessDataImgTemplate58mm struct {
	base *printerTemplate
}

// NewBusinessDataImgTemplate 创建新的图片订单打印模板
func NewBusinessDataImgTemplate58mm(
	base *printerTemplate,
) *businessDataImgTemplate58mm {
	return &businessDataImgTemplate58mm{
		base: base,
	}
}
...
func (t *businessDataImgTemplate58mm) GetPrintContent58mm(
	...
	if businessData.PaymentMethod != nil {
		...
		img.AppendText(t.base.Translate("实收金额"), pkg.WithFixedWidth(200))
		img.SetAlignment(pkg.AlignRight)
		img.AppendText(t.base.GetPriceAndUnit(businessData.PaymentMethod.TotalReceivedPrice), pkg.WithFixedWidth(0), pkg.WithDeviationWidth(14))
		img.SetAlignment(pkg.AlignLeft)
		img.LineFeed(1)
		img.AppendSplitLine()
		...
		for _, income := range businessData.PaymentMethod.PaymentMethodIncomes {
			...
			img.AppendText(income.Name, pkg.WithFixedWidth(200))
			img.SetAlignment(pkg.AlignRight)
			img.AppendText(t.base.GetPriceAndUnit(income.Amount), pkg.WithFixedWidth(0), pkg.WithDeviationWidth(14))
			img.SetAlignment(pkg.AlignLeft)
			img.LineFeed(1)
		}
		...
		img.PrintInColumns(
			...
			pkg.ColumnConfig{Text: t.base.Translate("数量"), Width: 65, Align: pkg.AlignRight, FontWeight: 1},
		...
		for _, category := range businessData.ProductCategory.CategoryList {
			img.PrintInColumns(
				pkg.ColumnConfig{Text: category.Name, Width: 190, Align: pkg.AlignLeft, FontWeight: 2},
				pkg.ColumnConfig{Text: t.base.FloatToString(category.SalesNum), Width: 65, Align: pkg.AlignRight, FontWeight: 2},
		...
		img.AppendSplitLine(pkg.WithLineFeed(true))
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("销售笔数"), Width: 190, Align: pkg.AlignLeft, FontWeight: 1},
		...
		if businessData.ProductCategory.TotalRefundMoney > 0 {
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("退款金额"), Width: 190, Align: pkg.AlignLeft, FontWeight: 1},
		...
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("实收金额"), Width: 190, Align: pkg.AlignLeft, FontWeight: 2, FontSize: 28},
		...
		img.SetTextLineHeight(50)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("商品名称"), Width: 190, Align: pkg.AlignLeft, FontWeight: 2},
			pkg.ColumnConfig{Text: t.base.Translate("销量"), Width: 80, Align: pkg.AlignRight, FontWeight: 2},
		...
		for _, product := range businessData.Product.Products {
			img.PrintInColumns(
				pkg.ColumnConfig{Text: product.Name, Width: 190, Align: pkg.AlignLeft},
				pkg.ColumnConfig{Text: fmt.Sprintf("%s*%v", t.base.Number(product.Price), product.SalesNum), Width: 80, Align: pkg.AlignRight},
		...
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("免单金额"), Width: 250, Align: pkg.AlignLeft, FontWeight: 1},
		...
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("实收金额"), Width: 260, Align: pkg.AlignLeft, FontWeight: 2, FontSize: 22},
		...
		img.SetAlignment(pkg.AlignLeft)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("订单数"), Width: 230, Align: pkg.AlignLeft},
			pkg.ColumnConfig{Text: fmt.Sprintf("%.0f", float64(businessData.All.UnclosedTotalOrderNum)), Width: 0, Align: pkg.AlignRight},
		)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("金额"), Width: 230, Align: pkg.AlignLeft},
		...
		img.LineFeed(1)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("订单数（桌数）"), Width: 260, Align: pkg.AlignLeft, FontWeight: 1},
		...
		if businessData.All.AllTakeawayOrderNum > 0 {
			...
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("订单数"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: fmt.Sprintf("%.0f", float64(businessData.All.AllTakeawayOrderNum)), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("最小/大订单金额"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: fmt.Sprintf("%s/%s", t.base.GetPriceAndUnit(businessData.All.AllTakeawayMinOrderPrice), t.base.GetPriceAndUnit(businessData.All.AllTakeawayMaxOrderPrice)), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("平均订单金额"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: t.base.GetPriceAndUnit(businessData.All.AllTakeawayAvgOrderPrice), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
		}
		// 点餐方式-扫码
		if businessData.All.AllScanOrderNum > 0 {
			img.LineFeed(1, 12)
			img.SetAlignment(pkg.AlignCenter)
			img.SetFontWeight(2)
			...
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("订单数"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: fmt.Sprintf("%.0f", float64(businessData.All.AllScanOrderNum)), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("最小/大订单金额"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: fmt.Sprintf("%s/%s", t.base.GetPriceAndUnit(businessData.All.AllScanMinOrderPrice), t.base.GetPriceAndUnit(businessData.All.AllScanMaxOrderPrice)), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("平均订单金额"), Width: 230, Align: pkg.AlignLeft, FontWeight: 1},
				pkg.ColumnConfig{Text: t.base.GetPriceAndUnit(businessData.All.AllScanAvgOrderPrice), Width: 0, Align: pkg.AlignRight, FontWeight: 1},
			)
		}
		// 支付方式
		img.AppendSplitLine()
		img.LineFeed(1)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("支付方式"), Width: utils.IfInt(isTrThEn || t.base.Lang == "sv", 166, 194), Align: pkg.AlignLeft, FontWeight: 2},
			pkg.ColumnConfig{Text: t.base.Translate("订单数"), Width: utils.IfInt(t.base.Lang == "en" || t.base.Lang == "sv", 158, 130), Align: pkg.AlignLeft, FontWeight: 2},
		...
		for _, income := range businessData.All.PaymentMethodIncomes {
			if income.Code != constant.PaymentMethodCodeFreePay {
				img.PrintInColumns(
					pkg.ColumnConfig{Text: income.Name, Width: utils.IfInt(isTrThEn, 166, 194), Align: pkg.AlignLeft, FontWeight: 2},
					pkg.ColumnConfig{Text: fmt.Sprintf("%v", income.OrderNum), Width: 69, Align: pkg.AlignLeft, FontWeight: 2},
		...
		if totalPayPrice.GreaterThan(decimal.NewFromFloat(0)) {
			img.PrintInColumns(
				pkg.ColumnConfig{Text: t.base.Translate("总金额"), Width: utils.IfInt(isTrThEn, 166, 194), Align: pkg.AlignLeft, FontWeight: 2},
				pkg.ColumnConfig{Text: "", Width: 69, Align: pkg.AlignLeft, FontWeight: 2},
		...
		img.SetTextLineHeight(45)
		// 高峰时间
		peakHoursWidth := utils.IfInt(isTrThEn, 166, 194)
		numberWidth := utils.IfInt(t.base.Lang == "en" || t.base.Lang == "sv", 158, 130)
		img.PrintInColumns(
			pkg.ColumnConfig{Text: t.base.Translate("高峰时间"), Width: utils.IfInt(t.base.Lang == "sv", 144, peakHoursWidth), Align: pkg.AlignLeft, FontWeight: 2},
			pkg.ColumnConfig{Text: t.base.Translate("订单数"), Width: utils.IfInt(t.base.Lang == "sv", 158, numberWidth), Align: pkg.AlignLeft, FontWeight: 2},
		...
		for _, peak := range businessData.All.PeakHourList {
			img.PrintInColumns(
				pkg.ColumnConfig{Text: peak.TimePeriod, Width: utils.IfInt(isTrThEn, 166, 194), Align: pkg.AlignLeft, FontWeight: 2},
				pkg.ColumnConfig{Text: fmt.Sprintf("%v", peak.OrderNum), Width: 69, Align: pkg.AlignLeft, FontWeight: 2},
