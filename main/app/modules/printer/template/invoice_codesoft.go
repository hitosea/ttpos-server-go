...
type invoiceCodesoftTemplate struct {
	base *printerTemplate
}

// NewInvoiceCodesoftTemplate 创建新的Codesoft发票打印模板
func NewInvoiceCodesoftTemplate(
	base *printerTemplate,
) *invoiceCodesoftTemplate {
	return &invoiceCodesoftTemplate{
		base: base,
	}
}
