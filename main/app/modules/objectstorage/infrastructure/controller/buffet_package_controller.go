...
func InitBuffetPackageController(
	...
	buffetPackageControllerOnce.Do(func() {
		buffetPackageControllerInstance = InitCacheObjectController[*model.BuffetPackage](
			underlyingCache,
			ttl,
...
func GetBuffetPackageController() *CacheObjectController[*model.BuffetPackage] {
	return buffetPackageControllerInstance
}
