...
func InitPaymentMethodController(
	...
	paymentMethodControllerOnce.Do(func() {
		paymentMethodControllerInstance = InitCacheObjectController[*model.PaymentMethod](
			underlyingCache,
			ttl,
...
func GetPaymentMethodController() *CacheObjectController[*model.PaymentMethod] {
	return paymentMethodControllerInstance
}
