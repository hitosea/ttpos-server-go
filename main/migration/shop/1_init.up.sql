...
CREATE TABLE IF NOT EXISTS `ttpos_member_level` (
    ...
    `open_points` TINYINT(3) DEFAULT 0 COMMENT '是否开放累计积分升级，0-否 1-是',
    `upgrade_points` INT(11) DEFAULT 0 COMMENT '升级条件，累计积分',
    `open_invite` TINYINT(3) DEFAULT 0 COMMENT '是否开放邀请升级，0-否 1-是',
    `upgrade_invite` INT(11) DEFAULT 0 COMMENT '升级条件，邀请人数',
