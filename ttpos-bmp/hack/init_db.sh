...
docker run --rm mariadb:10.11.6 $EXEC -e "CREATE DATABASE IF NOT EXISTS websocket DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
docker run --rm mariadb:10.11.6 $EXEC -e "GRANT ALL PRIVILEGES ON websocket.* TO '$DB_USERNAME'@'%'  WITH GRANT OPTION;"
