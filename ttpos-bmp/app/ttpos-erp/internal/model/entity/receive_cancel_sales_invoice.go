...
// ReceiveCancelSalesInvoice is the golang structure for table receive_cancel_sales_invoice.
type ReceiveCancelSalesInvoice struct {
	Id          int64  `json:"id"          orm:"id"           description:"ID"`                       // ID
	OrderNo     string `json:"orderNo"     orm:"order_no"     description:"订单号，来自ttpos"`              // 订单号，来自ttpos
