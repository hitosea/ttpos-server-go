...
type ReceivePaymentEntry struct {
	...
	ModeOfPayment    string  `json:"modeOfPayment"    orm:"mode_of_payment"    description:"支付方式"`                // 支付方式
	PaymentEntryName string  `json:"paymentEntryName" orm:"payment_entry_name" description:"ERP Payment Entry名称"` // ERP Payment Entry名称
	Docstatus        string  `json:"docstatus"        orm:"docstatus"          description:"文档状态"`                // 文档状态
	PaidAmount       float64 `json:"paidAmount"       orm:"paid_amount"        description:"支付金额"`                // 支付金额
