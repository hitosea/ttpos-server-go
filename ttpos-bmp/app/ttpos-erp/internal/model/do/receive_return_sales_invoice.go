...
// ReceiveReturnSalesInvoice is the golang structure of table erp_receive_return_sales_invoice for DAO operations like Where/Data.
type ReceiveReturnSalesInvoice struct {
	g.Meta            `orm:"table:erp_receive_return_sales_invoice, do:true"`
	Id                any // ID
	...
	SalesInvoiceName  any // Credit Note名称
	PaymentEntryNames any // Refund Payment Entry名称(JSON)
