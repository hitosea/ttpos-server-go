...
## 部署注意
1. 新增自定义DocType
2. 添加自定义字段，参考  manifest/erp-migrate/v2.5/custom_fields 脚本， 调用 /api/v2/document/{docType}
3. 新增服务端脚本 参考  manifest/erp-migrate/v2.5/server-scripts
4. 导入lianlianpay 类型数据
