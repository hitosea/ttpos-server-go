...
3. 执行 `main  migrate --siteCode 1 --dirBase ./manifest/erp-migrate/v2.5` 在erpnext中迁移脚本
4. 执行 `main  migrate --siteCode 1 --dirBase ./manifest/erp-migrate/payment` 在erpnext中迁移支付方式
