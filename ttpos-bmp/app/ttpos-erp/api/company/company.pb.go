...
const file_company_company_proto_rawDesc = "" +
	"\n" +
	"\x15company/company.proto\x12\acompany\"6\n" +
	...
	"\fcompany_name\x18\x02 \x01(\tR\vcompanyName2[\n" +
	"\x0eCompanyService\x12I\n" +
	"\x0eGetCompanyList\x12\x1a.company.GetCompanyListReq\x1a\x1b.company.GetCompanyListRespB%Z#ttpos-bmp/app/ttpos-erp/api/companyb\x06proto3"
...
var file_company_company_proto_depIdxs = []int32{
	...
	1, // 2: company.CompanyService.GetCompanyList:output_type -> company.GetCompanyListResp
