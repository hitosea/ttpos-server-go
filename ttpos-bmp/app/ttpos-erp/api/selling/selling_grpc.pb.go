...
func (c *sellingServiceClient) SaveModeOfPayment(ctx context.Context, in *SaveModeOfPaymentReq, opts ...grpc.CallOption) (*api.ResponseInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.ResponseInfo)
	err := c.cc.Invoke(ctx, SellingService_SaveModeOfPayment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSellingServiceServer) SaveSalesInvoice(context.Context, *SaveSalesInvoiceReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveSalesInvoice not implemented")
}
func (UnimplementedSellingServiceServer) CancelSalesInvoice(context.Context, *CancelSalesInvoiceReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelSalesInvoice not implemented")
}
func (UnimplementedSellingServiceServer) ReturnSalesInvoice(context.Context, *ReturnSalesInvoiceReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReturnSalesInvoice not implemented")
}
...
func (UnimplementedSellingServiceServer) GetModeOfPayment(context.Context, *GetModeOfPaymentReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetModeOfPayment not implemented")
}
func (UnimplementedSellingServiceServer) SaveModeOfPayment(context.Context, *SaveModeOfPaymentReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveModeOfPayment not implemented")
}
...
func _SellingService_SaveModeOfPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(SellingServiceServer).SaveModeOfPayment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SellingService_SaveModeOfPayment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SellingServiceServer).SaveModeOfPayment(ctx, req.(*SaveModeOfPaymentReq))
	}
	return interceptor(ctx, in, info, handler)
}
