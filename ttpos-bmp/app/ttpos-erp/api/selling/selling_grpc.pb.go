...
func (UnimplementedSellingServiceServer) GetPosProfileList(context.Context, *PosProfileReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPosProfileList not implemented")
}
...
func RegisterSellingServiceServer(s grpc.ServiceRegistrar, srv SellingServiceServer) {
	// If the following call panics, it indicates UnimplementedSellingServiceServer was
