...
func (UnimplementedDeliveryNoteServiceServer) GetDeliveryNoteList(context.Context, *GetDeliveryNoteListReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeliveryNoteList not implemented")
}
func (UnimplementedDeliveryNoteServiceServer) GetDeliveryNote(context.Context, *GetDeliveryNoteReq) (*api.ResponseInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeliveryNote not implemented")
}
...
func RegisterDeliveryNoteServiceServer(s grpc.ServiceRegistrar, srv DeliveryNoteServiceServer) {
	// If the following call pancis, it indicates UnimplementedDeliveryNoteServiceServer was
