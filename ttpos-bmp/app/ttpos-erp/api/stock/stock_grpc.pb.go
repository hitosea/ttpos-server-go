...
func (c *stockServiceClient) GetBin(ctx context.Context, in *GetBinReq, opts ...grpc.CallOption) (*api.ResponseInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.ResponseInfo)
	err := c.cc.Invoke(ctx, StockService_GetBin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStockServiceServer) SaveMaterialRequest(context.Context, *SaveMaterialRequestReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method SaveMaterialRequest not implemented")
}
func (UnimplementedStockServiceServer) GetMaterialRequestList(context.Context, *GetMaterialRequestListReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMaterialRequestList not implemented")
}
func (UnimplementedStockServiceServer) GetStockLedger(context.Context, *GetStockLedgerReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStockLedger not implemented")
}
func (UnimplementedStockServiceServer) SaveStockReconciliation(context.Context, *SaveStockReconciliationReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method SaveStockReconciliation not implemented")
}
func (UnimplementedStockServiceServer) GetStockReconciliationList(context.Context, *GetStockReconciliationListReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStockReconciliationList not implemented")
}
func (UnimplementedStockServiceServer) SubmitStockReconciliation(context.Context, *SubmitStockReconciliationReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitStockReconciliation not implemented")
}
func (UnimplementedStockServiceServer) CancelStockReconciliation(context.Context, *CancelStockReconciliationReq) (*api.ResponseInfo, error) {
	return nil, status.Error(codes.Unimplemented, "method CancelStockReconciliation not implemented")
}
...
func _StockService_GetBin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBinReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StockServiceServer).GetBin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StockService_GetBin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StockServiceServer).GetBin(ctx, req.(*GetBinReq))
	}
	return interceptor(ctx, in, info, handler)
}
