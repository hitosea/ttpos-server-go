...
func file_warehouse_warehouse_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_warehouse_warehouse_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_warehouse_warehouse_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_warehouse_warehouse_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
