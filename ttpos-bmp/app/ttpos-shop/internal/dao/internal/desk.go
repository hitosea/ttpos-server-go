...
type DeskColumns struct {
	...
	IsOpenDefaultPeopleNum string // 是否开启默认人数, 0-否 1-是
	DefaultPeopleNum       string // 默认人数
...
var deskColumns = DeskColumns{
	...
	IsOpenDefaultPeopleNum: "is_open_default_people_num",
	DefaultPeopleNum:       "default_people_num",
