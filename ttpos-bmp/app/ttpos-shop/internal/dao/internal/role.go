...
// RoleDao is the data access object for the table ttpos_role.
type RoleDao struct {
...
// RoleColumns defines and stores column names for the table ttpos_role.
...
// roleColumns holds the columns for the table ttpos_role.
