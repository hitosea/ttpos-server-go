...
type SaleBillSetting struct {
	...
	ServiceApply       interface{} // 是否收取服务费，0-不收取 1-收取。根据后台的服务费应用范围决定
	ServiceFeeBase     interface{} // 服务费计算基准, 0-商品惠后价 1-商品价格合计
	...
	OpenPointsExchange interface{} // 是否开启积分抵扣, 0-不开启 1-开启
