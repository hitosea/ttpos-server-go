...
type SaleBillSetting struct {
	...
	ServiceApply       int     `json:"serviceApply"       orm:"service_apply"        description:"是否收取服务费，0-不收取 1-收取。根据后台的服务费应用范围决定"`                                           // 是否收取服务费，0-不收取 1-收取。根据后台的服务费应用范围决定
	ServiceFeeBase     int     `json:"serviceFeeBase"     orm:"service_fee_base"     description:"服务费计算基准, 0-商品惠后价 1-商品价格合计"`                                                   // 服务费计算基准, 0-商品惠后价 1-商品价格合计
	...
	OpenPointsExchange int     `json:"openPointsExchange" orm:"open_points_exchange" description:"是否开启积分抵扣, 0-不开启 1-开启"`                                                        // 是否开启积分抵扣, 0-不开启 1-开启
	PointsExchangeRate float64 `json:"pointsExchangeRate" orm:"points_exchange_rate" description:"积分抵扣汇率,1积分抵扣多少元"`                                                             // 积分抵扣汇率,1积分抵扣多少元
	AutoPointsExchange int     `json:"autoPointsExchange" orm:"auto_points_exchange" description:"积分抵扣类型,0-手动抵扣 1-自动抵扣"`                                                        // 积分抵扣类型,0-手动抵扣 1-自动抵扣
