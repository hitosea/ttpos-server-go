...
// WarehouseMonthlyProductBomForm is the golang structure for table warehouse_monthly_product_bom_form.
type WarehouseMonthlyProductBomForm struct {
	...
	ProductBomUuid uint64  `json:"productBomUuid" orm:"product_bom_uuid" description:"商品bom uuid"`     // 商品bom uuid
