...
type MemberLevel struct {
	...
	PointsRate     string  `json:"pointsRate"     orm:"points_rate"     description:"购物赠送积分按照付款金额比例赠送时的比例"`                   // 购物赠送积分按照付款金额比例赠送时的比例
	PointsQuantity string  `json:"pointsQuantity" orm:"points_quantity" description:"购物赠送积分按照桌台人数赠送时的数量"`                     // 购物赠送积分按照桌台人数赠送时的数量
