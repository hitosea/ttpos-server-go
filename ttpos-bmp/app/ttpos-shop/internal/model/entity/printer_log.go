...
type PrinterLog struct {
	...
	DataType           int    `json:"dataType"           orm:"data_type"            description:"数据类型 1-交班单 2-结账单 3-预结账单 4-一菜一单 5-营业数据 6-整单打印 7-打印发票 8-充值单 9-退菜单"` // 数据类型 1-交班单 2-结账单 3-预结账单 4-一菜一单 5-营业数据 6-整单打印 7-打印发票 8-充值单 9-退菜单
	...
	PrintingTime       int    `json:"printingTime"       orm:"printing_time"        description:"打印耗时(毫秒)"`                                                        // 打印耗时(毫秒)
	Copies             int    `json:"copies"             orm:"copies"               description:"打印份数"`                                                            // 打印份数
