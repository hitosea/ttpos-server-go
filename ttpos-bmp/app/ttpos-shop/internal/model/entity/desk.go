...
type Desk struct {
	...
	IsOpenDefaultPeopleNum int    `json:"isOpenDefaultPeopleNum" orm:"is_open_default_people_num" description:"是否开启默认人数, 0-否 1-是"`                             // 是否开启默认人数, 0-否 1-是
	DefaultPeopleNum       int    `json:"defaultPeopleNum"       orm:"default_people_num"         description:"默认人数"`                                          // 默认人数
