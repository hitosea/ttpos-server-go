...
type Printer struct {
	...
	IsUsb             uint   `json:"isUsb"             orm:"is_usb"              description:"是否usb 0-否 1-是"`   // 是否usb 0-否 1-是
	IsEnableUsb       uint   `json:"isEnableUsb"       orm:"is_enable_usb"       description:"是否启用usb 0-否 1-是"` // 是否启用usb 0-否 1-是
	Status            uint   `json:"status"            orm:"status"              description:"状态 0-离线 1-在线"`    // 状态 0-离线 1-在线
	LastHeartbeatTime uint   `json:"lastHeartbeatTime" orm:"last_heartbeat_time" description:"最后心跳时间"`          // 最后心跳时间
