...
// ProductAttribute is the golang structure for table product_attribute.
type ProductAttribute struct {
	...
	AttributeGroupUuid    uint64 `json:"attributeGroupUuid"    orm:"attribute_group_uuid"     description:"属性组ID"`     // 属性组ID
