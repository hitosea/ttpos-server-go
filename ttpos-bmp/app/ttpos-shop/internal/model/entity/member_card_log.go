...
type MemberCardLog struct {
	...
	Expire             int64   `json:"expire"             orm:"expire"                description:"有效期限,单位:月, 0为永久有效,不随后台改变,记录领取时的有效期限"`                     // 有效期限,单位:月, 0为永久有效,不随后台改变,记录领取时的有效期限
	...
	GiveMoney          float64 `json:"giveMoney"          orm:"give_money"            description:"赠送余额"`                                                    // 赠送余额
