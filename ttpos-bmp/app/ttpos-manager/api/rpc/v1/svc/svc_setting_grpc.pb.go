...
type SettingSvcClient interface {
	GetSetting(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*v1.Setting, error)
}
...
func (c *settingSvcClient) GetSetting(ctx context.Context, in *GetReq, opts ...grpc.CallOption) (*v1.Setting, error) {
...
type SettingSvcServer interface {
	GetSetting(context.Context, *GetReq) (*v1.Setting, error)
...
func (UnimplementedSettingSvcServer) GetSetting(context.Context, *GetReq) (*v1.Setting, error) {
