...
// AdminUserRoleColumns defines and stores column names for the table ttpos_admin_user_role.
type AdminUserRoleColumns struct {
	Id          string // 自增ID
	AdminUserId string // 超管用户ID
	RoleId      string // 角色ID
...
// adminUserRoleColumns holds the columns for the table ttpos_admin_user_role.
