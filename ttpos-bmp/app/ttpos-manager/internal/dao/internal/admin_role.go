...
// AdminRoleDao is the data access object for the table ttpos_admin_role.
...
// AdminRoleColumns defines and stores column names for the table ttpos_admin_role.
...
// adminRoleColumns holds the columns for the table ttpos_admin_role.
