...
// WebSocketMsgColumns defines and stores column names for the table ttpos_web_socket_msg.
type WebSocketMsgColumns struct {
	...
	IsOffline    string // 是否离线消息 0-否 1-是
	Remark       string // 备注
...
// webSocketMsgColumns holds the columns for the table ttpos_web_socket_msg.
