...
**Name:** Order Update Notification API (Webhook)
...
| orderUpdatedTime | String | M | 订单更新时间，ISO 8601 格式，如：2022-11-01T13:08:06+07:00 |
...
| items[].discount | double | O | 促销折扣金额 |
...
| additionalItems[].name | String | M | 附加信息，如："ไม่รับช้อนส้อมพลาสติก" |
